...
class chip_info(object):
    ...
    _supported_chips_list     = [A7DA_KAS, CRESCENDO, STRE, NAPIER]
    _pm_octet_addressing_list = [CRESCENDO, A7DA_KAS, STRE, NAPIER]
    _dm_octet_addressing_list = [CRESCENDO, STRE, NAPIER]
    _kal_arch4_list           = [CRESCENDO, STRE, NAPIER]
    _kal_arch5_list           = [A7DA_KAS]
    _minim_list               = [A7DA_KAS, CRESCENDO, STRE, NAPIER]

    _kld_list                 = [CRESCENDO, STRE, NAPIER]
    _mark_code_section_type   = [CRESCENDO, STRE, NAPIER]

    # Get this from http://wiki/ChipVersionIDs
    # DSP_ID in A7DA chip is a special case, see B-159218 if interested
    _dsp_id_dict = {GORDON: 0xC9, A7DA_KAS: 0x60A0, NAPIER: 0x61, CRESCENDO: 0x46, STRE: 0x49}

    _default_kcs_type = {GORDON: KCSFile.STREAM_TYPE, A7DA_KAS: KCSFile.RANDOM_ACCESS_TYPE, CRESCENDO: KCSFile.STREAM_TYPE, STRE: KCSFile.STREAM_TYPE, NAPIER: KCSFile.STREAM_TYPE}

    # Conversion table for CRT libraries
    _crt_lib_name = {A7DA_KAS: "a7da", CRESCENDO : "csra68100_audio", STRE : "QCC3400_audio", NAPIER : "napier_audio"}
