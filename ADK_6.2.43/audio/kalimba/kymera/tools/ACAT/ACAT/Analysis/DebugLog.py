    ...
    def _get_formatter_string(self, string_ptr, arguments):
        ...
        if region == 'DBG_DWL':
            ...
            try:
                ...
                mystr = (
                    self.debuginfo.bundles[self.current_elf_id]
                    .debug_strings.get(string_ptr - 0x2000000)
                )
            ...
            # TODO: do we need address conversation for the patch elf?
            ...
            if re.search("arguments number is required", str(exception)):
                ...
                for idx, val in enumerate(specifiers):
                    ...
                    if not re.search("[cs]", val) and isinstance(
                        ...
                        for addr, string in self.debuginfo.get_kymera_debuginfo().debug_strings.items(
                        ):
