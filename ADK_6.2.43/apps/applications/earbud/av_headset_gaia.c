...
static void appGaiaHandleInternalConnect(const APP_GAIA_CONNECT_ALLOWED_IND_T *ind)
{
...
static void appGaiaMessageHandler(Task task, MessageId id, Message message)
{
    ...
    switch (id)
    {
        case APP_GAIA_CONNECT_ALLOWED_IND:
            appGaiaHandleInternalConnect((const APP_GAIA_CONNECT_ALLOWED_IND_T *)message);
            break;
