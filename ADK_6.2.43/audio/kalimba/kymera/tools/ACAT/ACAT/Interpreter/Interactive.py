...
def get_potential_object_names(object_dict, object_start_name):
    ...
    varible1,
    varible1.attribute1
    varible1.attribute1.sub_attribute1,
    varible1.attribute1.sub_attribute2,
    varible1.attribute2,
    varible2,
    varible2.attribute1
    ...
    On the other hand if the object_start_name is "varible1." the function will
    return the full name of the variable1 attributes which are:
    varible1.attribute1
    varible1.attribute2
    Therefore "varible1." is like a scope in the environment.

    Note. "varible1.blah" will return:
    varible1.attribute1
    varible1.attribute2
...
class Interactive(Interpreter):
    ...
    def run(self):
        ...
        # confusing users.
        user_variables["get"] = processor.get_func
        user_variables["get_var"] = processor.get_var_func
        user_variables["get_reg"] = processor.get_reg_func
