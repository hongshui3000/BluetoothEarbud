...
typedef struct
{
    ...
    sbc_encoder_common va_sbc_encoder_params;
} audio_config_t;
...
#define DEFAULT_VA_SBC_ENCODER_FORMAT           0x0033
...
void AudioConfigSetSbcEncoderParams(sbc_encoder_common sbc_encoder_params)
{
    audio_config.va_sbc_encoder_params = sbc_encoder_params;
}

sbc_encoder_common AudioConfigGetSbcEncoderParams(void)
{
...
void AudioConfigTestReset(void)
{
    ...
    audio_config.va_sbc_encoder_params.sbc_encoder_format = DEFAULT_VA_SBC_ENCODER_FORMAT;
    audio_config.va_sbc_encoder_params.sbc_encoder_bitpool = DEFAULT_VA_SBC_BITPOOL;
