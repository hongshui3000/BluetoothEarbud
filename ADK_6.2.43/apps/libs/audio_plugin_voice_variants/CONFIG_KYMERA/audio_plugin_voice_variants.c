...
extern CvcPluginTaskdata usb_wb_cvc_1mic_handsfree_plugin;
extern CvcPluginTaskdata usb_nb_cvc_1mic_handsfree_plugin;
extern CvcPluginTaskdata usb_nb_cvc_2mic_handsfree_plugin;
extern CvcPluginTaskdata usb_wb_cvc_2mic_handsfree_plugin;
...
#define USB_CVCHF2MICBINAURAL  (TaskData *)&usb_nb_cvc_2mic_headset_binaural_plugin
#define USB_CVCHF2MICBINAURALWBS   (TaskData *)&usb_wb_cvc_2mic_headset_binaural_plugin

/* USB Handsfree plugins */
#define USB_CVCHF1MIC       (TaskData *)&usb_nb_cvc_1mic_handsfree_plugin
#define USB_CVCHF1MICWBS    (TaskData *)&usb_wb_cvc_1mic_handsfree_plugin
#define USB_CVCHF2MIC       (TaskData *)&usb_nb_cvc_2mic_handsfree_plugin
#define USB_CVCHF2MICWBS    (TaskData *)&usb_wb_cvc_2mic_handsfree_plugin
