...
#define SOURCE_SINK_TO_UINT16(src_or_snk) ((uint16)((uint32)(src_or_snk))&0xffff);
                                               ...
                                               uint16 *value)
{
    switch (id)
    {
        ...
        {
            *value = SOURCE_SINK_TO_UINT16(usbAudioSpeakerSource());
            return usb_device_class_status_success;
        }
        case USB_DEVICE_CLASS_GET_VALUE_AUDIO_SINK:
        {
            *value = SOURCE_SINK_TO_UINT16(usbAudioMicSink());
            return usb_device_class_status_success;
        }
