...
/*!
    @brief Structure common to all plugins, configure the SBC encoder params.
    sbc_encoder_format:
...
typedef struct
{
    /*! The SBC encoder Format */
    uint8      sbc_encoder_format;
    /*! The SBC encoder Bitpool */
    uint8       sbc_encoder_bitpool;
}sbc_encoder_common;
