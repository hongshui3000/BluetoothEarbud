 ...
 */
/**
 * \defgroup led_cfg led_cfg
 * \ingroup core
 * \section led_cfg INTRODUCTION
 * This module implements wrapper API for controlling the LED.
 * The API is called by LedConfigure trap code and Production test of LED.
 */
#ifndef LED_CFG_H
#define LED_CFG_H
