...
In $CrescendoExternalName is not possible to achieve the same period as other chips above.
...
In $CrescendoExternalName the flash rate has changed. The LED_FLASH_RATE value has to be used
...
This configuration key is not supported by $CrescendoExternalName LED controller
hardware.
     */
    LED_FLASH_SEL_DRIVE,
