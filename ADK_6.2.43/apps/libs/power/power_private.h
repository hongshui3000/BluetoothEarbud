...
typedef struct
{
    ...
    uint8               vterm;                  /* Most recent termination voltage setting. */
    ...
    uint16              calculated_external_resistance_in_milli_ohms;   /* External resistance based on a number of factors. */
} power_type;
