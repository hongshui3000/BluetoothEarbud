...
class Functions(object):
    ...
    def get_func(self, identifier, elf_id=None, datalen=None):
        """
...
class Processor(Functions):
    ...
    def is_booted(self):
        ...
        @param[in] self Pointer to the current object
        """
        proc_program_counter = self.chipdata.get_reg_strict("regfile_pc").value
