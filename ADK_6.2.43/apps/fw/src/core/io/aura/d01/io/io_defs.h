...
/* *************************************************************************  *
   ...
   $Id: //depot/bg/Releases/ADK/ADK6.2/hydra_os_aura/fw/src/core/io/aura/d01/io/io_defs.h#1 $
   $Name$
   $Source$
...
#if defined(IO_DEFS_MODULE_UART) 

#ifndef __IO_DEFS_H__IO_DEFS_MODULE_UART
#define __IO_DEFS_H__IO_DEFS_MODULE_UART

/* -- uart -- Common UART registers: Any SS can (but probably should not!) access these registers -- */

enum h4_packet_indicator_enum
{
   H4_PACKET_INDICATOR_COMMAND              = (int)0x1,
   H4_PACKET_INDICATOR_ACL                  = (int)0x2,
   H4_PACKET_INDICATOR_SCO                  = (int)0x3,
   H4_PACKET_INDICATOR_EVENT                = (int)0x4,
   H4_PACKET_INDICATOR_H4PLUS_NEGOTIATION   = (int)0x6,
   H4_PACKET_INDICATOR_H4PLUS_ALIVE         = (int)0x7,
   H4_PACKET_INDICATOR_H4PLUS_FM            = (int)0x8,
   H4_PACKET_INDICATOR_H4PLUS_RDF           = (int)0xA,
   H4_PACKET_INDICATOR_H4DS_LOCK            = (int)0x40,
   MAX_H4_PACKET_INDICATOR                  = (int)0x40
};
typedef enum h4_packet_indicator_enum h4_packet_indicator;


enum hci_acl_bc_flag_enum
{
   HCI_ACL_BC_FLAG_BCAST_NON                = (int)0x0,
   HCI_ACL_BC_FLAG_BCAST_ACTIVE             = (int)0x1,
   HCI_ACL_BC_FLAG_BCAST_ALL                = (int)0x2,
   HCI_ACL_BC_FLAG_BCAST_RSVD               = (int)0x3,
   MAX_HCI_ACL_BC_FLAG                      = (int)0x3
};
#define NUM_HCI_ACL_BC_FLAG (0x4)
typedef enum hci_acl_bc_flag_enum hci_acl_bc_flag;


enum hci_acl_pb_flag_enum
{
   HCI_ACL_PB_FLAG_START_NONFLUSH           = (int)0x0,
   HCI_ACL_PB_FLAG_CONT                     = (int)0x1,
   HCI_ACL_PB_FLAG_START_FLUSH              = (int)0x2,
   HCI_ACL_PB_FLAG_RSVD_3                   = (int)0x3,
   MAX_HCI_ACL_PB_FLAG                      = (int)0x3
};
#define NUM_HCI_ACL_PB_FLAG (0x4)
typedef enum hci_acl_pb_flag_enum hci_acl_pb_flag;


enum io_data_h5_protocol_id_enum
{
   IO_DATA_H5_PROTOCOL_NULL                 = (int)0x0,
   IO_DATA_H5_PROTOCOL_HCI_CMD              = (int)0x1,
   IO_DATA_H5_PROTOCOL_HCI_ACL              = (int)0x2,
   IO_DATA_H5_PROTOCOL_HCI_SCO              = (int)0x3,
   IO_DATA_H5_PROTOCOL_HCI_EVT              = (int)0x4,
   IO_DATA_H5_PROTOCOL_VENDOR               = (int)0xE,
   IO_DATA_H5_PROTOCOL_LINK_MGT             = (int)0xF,
   MAX_IO_DATA_H5_PROTOCOL_ID               = (int)0xF
};
typedef enum io_data_h5_protocol_id_enum io_data_h5_protocol_id;


enum io_data_hx_protocol_id_enum
{
   IO_DATA_HX_PROTOCOL_HCI_CMD              = (int)0x1,
   IO_DATA_HX_PROTOCOL_HCI_ACL              = (int)0x2,
   IO_DATA_HX_PROTOCOL_HCI_SCO              = (int)0x3,
   IO_DATA_HX_PROTOCOL_HCI_EVT              = (int)0x4,
   IO_DATA_HX_PROTOCOL_LINK_MGT             = (int)0xF,
   MAX_IO_DATA_HX_PROTOCOL_ID               = (int)0xF
};
typedef enum io_data_hx_protocol_id_enum io_data_hx_protocol_id;


enum io_data_packet_header_posn_enum
{
   IO_DATA_PACKET_HEADER_H4_PKT_TYPE_LSB_POSN         = (int)0,
   IO_DATA_PACKET_HEADER_IO_DATA_PACKET_HEADER_H4_PKT_TYPE_LSB_POSN = (int)0,
   IO_DATA_PACKET_HEADER_H4_PKT_TYPE_MSB_POSN         = (int)7,
   IO_DATA_PACKET_HEADER_IO_DATA_PACKET_HEADER_H4_PKT_TYPE_MSB_POSN = (int)7,
   IO_DATA_PACKET_HEADER_PKT_TYPE_LSB_POSN            = (int)8,
   IO_DATA_PACKET_HEADER_IO_DATA_PACKET_HEADER_PKT_TYPE_LSB_POSN = (int)8,
   IO_DATA_PACKET_HEADER_PKT_TYPE_MSB_POSN            = (int)11,
   IO_DATA_PACKET_HEADER_IO_DATA_PACKET_HEADER_PKT_TYPE_MSB_POSN = (int)11,
   IO_DATA_PACKET_HEADER_LENGTH_LSB_POSN              = (int)12,
   IO_DATA_PACKET_HEADER_IO_DATA_PACKET_HEADER_LENGTH_LSB_POSN = (int)12,
   IO_DATA_PACKET_HEADER_LENGTH_MSB_POSN              = (int)23,
   IO_DATA_PACKET_HEADER_IO_DATA_PACKET_HEADER_LENGTH_MSB_POSN = (int)23
};
typedef enum io_data_packet_header_posn_enum io_data_packet_header_posn;

#define IO_DATA_PACKET_HEADER_H4_PKT_TYPE_LSB_MASK (0x00000001u)
#define IO_DATA_PACKET_HEADER_H4_PKT_TYPE_MSB_MASK (0x00000080u)
#define IO_DATA_PACKET_HEADER_PKT_TYPE_LSB_MASK  (0x00000100u)
#define IO_DATA_PACKET_HEADER_PKT_TYPE_MSB_MASK  (0x00000800u)
#define IO_DATA_PACKET_HEADER_LENGTH_LSB_MASK    (0x00001000u)
#define IO_DATA_PACKET_HEADER_LENGTH_MSB_MASK    (0x00800000u)

enum io_data_payload_header_posn_enum
{
   IO_DATA_PAYLOAD_HEADER_HCI_HNDL_LSB_POSN           = (int)0,
   IO_DATA_PAYLOAD_HEADER_IO_DATA_PAYLOAD_HEADER_HCI_HNDL_LSB_POSN = (int)0,
   IO_DATA_PAYLOAD_HEADER_HCI_HNDL_MSB_POSN           = (int)11,
   IO_DATA_PAYLOAD_HEADER_IO_DATA_PAYLOAD_HEADER_HCI_HNDL_MSB_POSN = (int)11,
   IO_DATA_PAYLOAD_HEADER_HCI_BC_FLAG_LSB_POSN        = (int)14,
   IO_DATA_PAYLOAD_HEADER_IO_DATA_PAYLOAD_HEADER_HCI_BC_FLAG_LSB_POSN = (int)14,
   IO_DATA_PAYLOAD_HEADER_HCI_BC_FLAG_MSB_POSN        = (int)15,
   IO_DATA_PAYLOAD_HEADER_IO_DATA_PAYLOAD_HEADER_HCI_BC_FLAG_MSB_POSN = (int)15
};
typedef enum io_data_payload_header_posn_enum io_data_payload_header_posn;

#define IO_DATA_PAYLOAD_HEADER_HCI_HNDL_LSB_MASK (0x00000001u)
#define IO_DATA_PAYLOAD_HEADER_HCI_HNDL_MSB_MASK (0x00000800u)
#define IO_DATA_PAYLOAD_HEADER_HCI_BC_FLAG_LSB_MASK (0x00004000u)
#define IO_DATA_PAYLOAD_HEADER_HCI_BC_FLAG_MSB_MASK (0x00008000u)

enum io_data_protocol_id_enum
{
   IO_DATA_PROTOCOL_NULL                    = (int)0x0,
   IO_DATA_PROTOCOL_LINK_MGT                = (int)0x1,
   IO_DATA_PROTOCOL_CHIP_MGT_HC             = (int)0x2,
   IO_DATA_PROTOCOL_CHIP_MGT_CH             = (int)0x3,
   IO_DATA_PROTOCOL_DEVICE_MGT              = (int)0x4,
   IO_DATA_PROTOCOL_HCI_CMD_EVT             = (int)0x5,
   IO_DATA_PROTOCOL_HCI_ACL                 = (int)0x6,
   IO_DATA_PROTOCOL_HCI_SCO                 = (int)0x7,
   IO_DATA_PROTOCOL_L2CAP                   = (int)0x8,
   IO_DATA_PROTOCOL_RFCOMM                  = (int)0x9,
   IO_DATA_PROTOCOL_SDD                     = (int)0xA,
   IO_DATA_PROTOCOL_RSVD_ID_11              = (int)0xB,
   IO_DATA_PROTOCOL_DFU                     = (int)0xC,
   IO_DATA_PROTOCOL_VM                      = (int)0xD,
   IO_DATA_PROTOCOL_RSVD_ID_14              = (int)0xE,
   IO_DATA_PROTOCOL_RSVD_ID_15              = (int)0xF,
   MAX_IO_DATA_PROTOCOL_ID                  = (int)0xF
};
#define NUM_IO_DATA_PROTOCOL_ID (0x10)
typedef enum io_data_protocol_id_enum io_data_protocol_id;


enum protocol_acceleration_enum
{
   NO_PROTOCOL_ACCELERATION                 = (int)0x1,
   PROTOCOL_ACCELERATION_EXISTS             = (int)0x0,
   MAX_PROTOCOL_ACCELERATION                = (int)0x1
};
typedef enum protocol_acceleration_enum protocol_acceleration;


enum uart_event_group_indices_enum
{
   UART_EVENT_GROUP_RX_SUCCESS              = (int)0x0,
   UART_EVENT_GROUP_TX_SUCCESS              = (int)0x1,
   UART_EVENT_GROUP_RX_ERROR                = (int)0x2,
   UART_EVENT_GROUP_TX_ERROR                = (int)0x3,
   UART_EVENT_GROUP_NO_ACTIVITY             = (int)0x4,
   UART_EVENT_GROUP_RX_IDLE                 = (int)0x5,
   UART_EVENT_GROUP_SEQUENCE_FOUND          = (int)0x6,
   UART_EVENT_GROUP_PACKET_TIMEOUT          = (int)0x7,
   UART_EVENT_GROUP_ED_WRITE_ERROR          = (int)0x8,
   MAX_UART_EVENT_GROUP_INDICES             = (int)0x8
};
#define NUM_UART_EVENT_GROUP_INDICES (0x9)
typedef enum uart_event_group_indices_enum uart_event_group_indices;


enum uart_hci_type_enum
{
   HCI_TYPE_NONE                            = (int)0x0,
   HCI_TYPE_ACL                             = (int)0x1,
   HCI_TYPE_SCO                             = (int)0x2,
   MAX_UART_HCI_TYPE                        = (int)0x2
};
#define NUM_UART_HCI_TYPE (0x3)
typedef enum uart_hci_type_enum uart_hci_type;


enum uart_protocol_mapping_reg_posn_enum
{
   UART_PROTOCOL_MAPPING_ID_LSB_POSN                  = (int)0,
   UART_PROTOCOL_MAPPING_REG_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_ID_MSB_POSN                  = (int)7,
   UART_PROTOCOL_MAPPING_REG_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN            = (int)8,
   UART_PROTOCOL_MAPPING_REG_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN            = (int)9,
   UART_PROTOCOL_MAPPING_REG_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN    = (int)10,
   UART_PROTOCOL_MAPPING_REG_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN    = (int)13,
   UART_PROTOCOL_MAPPING_REG_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_VALID_POSN                   = (int)14,
   UART_PROTOCOL_MAPPING_REG_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_REG_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_reg_posn_enum uart_protocol_mapping_reg_posn;

#define UART_PROTOCOL_MAPPING_ID_LSB_MASK        (0x00000001u)
#define UART_PROTOCOL_MAPPING_ID_MSB_MASK        (0x00000080u)
#define UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_MASK  (0x00000100u)
#define UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_MASK  (0x00000200u)
#define UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_MASK (0x00000400u)
#define UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_MASK (0x00002000u)
#define UART_PROTOCOL_MAPPING_VALID_MASK         (0x00004000u)

enum uart_protocol_mapping_hci_type_enum
{
   UART_PROTOCOL_MAPPING_HCI_TYPE_NONE      = (int)0x0,
   UART_PROTOCOL_MAPPING_HCI_TYPE_ACL       = (int)0x1,
   UART_PROTOCOL_MAPPING_HCI_TYPE_SCO       = (int)0x2,
   MAX_UART_PROTOCOL_MAPPING_HCI_TYPE       = (int)0x2
};
#define NUM_UART_PROTOCOL_MAPPING_HCI_TYPE (0x3)
typedef enum uart_protocol_mapping_hci_type_enum uart_protocol_mapping_hci_type;


enum uart_rx_error_group_event_indices_enum
{
   UART_RX_ERROR_GROUP_RX_HOST_INTERFACE_ERROR_EVENT_INDEX = (int)0x0,
   UART_RX_ERROR_GROUP_RX_PAYLOAD_BUFFER_ERROR_EVENT_INDEX = (int)0x1,
   UART_RX_ERROR_GROUP_RX_HCI_PAYLOAD_LENGTH_ERROR_EVENT_INDEX = (int)0x2,
   MAX_UART_RX_ERROR_GROUP_EVENT_INDICES    = (int)0x2
};
#define NUM_UART_RX_ERROR_GROUP_EVENT_INDICES (0x3)
typedef enum uart_rx_error_group_event_indices_enum uart_rx_error_group_event_indices;


enum uart_rx_protocol_enum
{
   UART_RX_PROTOCOL_NONE                    = (int)0x0,
   UART_RX_PROTOCOL_BCSP                    = (int)0x1,
   UART_RX_PROTOCOL_H4                      = (int)0x2,
   MAX_UART_RX_PROTOCOL                     = (int)0x2
};
#define NUM_UART_RX_PROTOCOL (0x3)
typedef enum uart_rx_protocol_enum uart_rx_protocol;


enum uart_rx_success_group_event_indices_enum
{
   UART_RX_SUCCESS_GROUP_RX_SUCCESS_EVENT_INDEX = (int)0x0,
   MAX_UART_RX_SUCCESS_GROUP_EVENT_INDICES  = (int)0x0
};
#define NUM_UART_RX_SUCCESS_GROUP_EVENT_INDICES (0x1)
typedef enum uart_rx_success_group_event_indices_enum uart_rx_success_group_event_indices;


enum uart_tx_error_group_event_indices_enum
{
   UART_TX_ERROR_GROUP_TX_HOST_INTERFACE_ERROR_EVENT_INDEX = (int)0x0,
   UART_TX_ERROR_GROUP_TX_DATA_BUFFER_ERROR_EVENT_INDEX = (int)0x1,
   UART_TX_ERROR_GROUP_TX_DATA_READ_ERROR_EVENT_INDEX = (int)0x2,
   UART_TX_ERROR_GROUP_TX_TD_BUFFER_ERROR_EVENT_INDEX = (int)0x3,
   UART_TX_ERROR_GROUP_TX_TD_READ_ERROR_EVENT_INDEX = (int)0x4,
   UART_TX_ERROR_GROUP_TX_TD_UNSUPPORTED_PROTOCOL_EVENT_INDEX = (int)0x5,
   MAX_UART_TX_ERROR_GROUP_EVENT_INDICES    = (int)0x5
};
#define NUM_UART_TX_ERROR_GROUP_EVENT_INDICES (0x6)
typedef enum uart_tx_error_group_event_indices_enum uart_tx_error_group_event_indices;


enum uart_tx_protocol_enum
{
   UART_TX_PROTOCOL_NONE                    = (int)0x0,
   UART_TX_PROTOCOL_BCSP                    = (int)0x1,
   UART_TX_PROTOCOL_H4                      = (int)0x2,
   UART_TX_PROTOCOL_CHANGE_BUFFER_OFFSET    = (int)0xD,
   UART_TX_PROTOCOL_NOP_EVENT               = (int)0xE,
   UART_TX_PROTOCOL_NOP_SILENT              = (int)0xF,
   MAX_UART_TX_PROTOCOL                     = (int)0xF
};
typedef enum uart_tx_protocol_enum uart_tx_protocol;


enum uart_tx_success_group_event_indices_enum
{
   UART_TX_SUCCESS_GROUP_TX_SUCCESS_EVENT_INDEX = (int)0x0,
   UART_TX_SUCCESS_GROUP_TX_NOP_EVENT_INDEX = (int)0x1,
   MAX_UART_TX_SUCCESS_GROUP_EVENT_INDICES  = (int)0x1
};
#define NUM_UART_TX_SUCCESS_GROUP_EVENT_INDICES (0x2)
typedef enum uart_tx_success_group_event_indices_enum uart_tx_success_group_event_indices;


enum uart_bcsp_rx_last_seq_num_read_posn_enum
{
   UART_BCSP_RX_LAST_SEQ_NUM_READ_LSB_POSN            = (int)0,
   UART_BCSP_RX_LAST_SEQ_NUM_READ_UART_BCSP_RX_LAST_SEQ_NUM_READ_LSB_POSN = (int)0,
   UART_BCSP_RX_LAST_SEQ_NUM_READ_MSB_POSN            = (int)2,
   UART_BCSP_RX_LAST_SEQ_NUM_READ_UART_BCSP_RX_LAST_SEQ_NUM_READ_MSB_POSN = (int)2,
   UART_BCSP_RX_PROT_ID_READ_LSB_POSN                 = (int)3,
   UART_BCSP_RX_LAST_SEQ_NUM_READ_UART_BCSP_RX_PROT_ID_READ_LSB_POSN = (int)3,
   UART_BCSP_RX_PROT_ID_READ_MSB_POSN                 = (int)6,
   UART_BCSP_RX_LAST_SEQ_NUM_READ_UART_BCSP_RX_PROT_ID_READ_MSB_POSN = (int)6
};
typedef enum uart_bcsp_rx_last_seq_num_read_posn_enum uart_bcsp_rx_last_seq_num_read_posn;

#define UART_BCSP_RX_LAST_SEQ_NUM_READ_LSB_MASK  (0x00000001u)
#define UART_BCSP_RX_LAST_SEQ_NUM_READ_MSB_MASK  (0x00000004u)
#define UART_BCSP_RX_PROT_ID_READ_LSB_MASK       (0x00000008u)
#define UART_BCSP_RX_PROT_ID_READ_MSB_MASK       (0x00000040u)

enum uart_bcsp_rx_last_seq_num_write_posn_enum
{
   UART_BCSP_RX_LAST_SEQ_NUM_WRITE_LSB_POSN           = (int)0,
   UART_BCSP_RX_LAST_SEQ_NUM_WRITE_UART_BCSP_RX_LAST_SEQ_NUM_WRITE_LSB_POSN = (int)0,
   UART_BCSP_RX_LAST_SEQ_NUM_WRITE_MSB_POSN           = (int)2,
   UART_BCSP_RX_LAST_SEQ_NUM_WRITE_UART_BCSP_RX_LAST_SEQ_NUM_WRITE_MSB_POSN = (int)2,
   UART_BCSP_RX_PROT_ID_WRITE_LSB_POSN                = (int)3,
   UART_BCSP_RX_LAST_SEQ_NUM_WRITE_UART_BCSP_RX_PROT_ID_WRITE_LSB_POSN = (int)3,
   UART_BCSP_RX_PROT_ID_WRITE_MSB_POSN                = (int)6,
   UART_BCSP_RX_LAST_SEQ_NUM_WRITE_UART_BCSP_RX_PROT_ID_WRITE_MSB_POSN = (int)6
};
typedef enum uart_bcsp_rx_last_seq_num_write_posn_enum uart_bcsp_rx_last_seq_num_write_posn;

#define UART_BCSP_RX_LAST_SEQ_NUM_WRITE_LSB_MASK (0x00000001u)
#define UART_BCSP_RX_LAST_SEQ_NUM_WRITE_MSB_MASK (0x00000004u)
#define UART_BCSP_RX_PROT_ID_WRITE_LSB_MASK      (0x00000008u)
#define UART_BCSP_RX_PROT_ID_WRITE_MSB_MASK      (0x00000040u)

enum uart_config_posn_enum
{
   UART_CONFIG_TWO_STOP_BITS_POSN                     = (int)0,
   UART_CONFIG_UART_CONFIG_TWO_STOP_BITS_LSB_POSN     = (int)0,
   UART_CONFIG_UART_CONFIG_TWO_STOP_BITS_MSB_POSN     = (int)0,
   UART_CONFIG_ONE_PARITY_BIT_POSN                    = (int)1,
   UART_CONFIG_UART_CONFIG_ONE_PARITY_BIT_LSB_POSN    = (int)1,
   UART_CONFIG_UART_CONFIG_ONE_PARITY_BIT_MSB_POSN    = (int)1,
   UART_CONFIG_EVEN_PARITY_POSN                       = (int)2,
   UART_CONFIG_UART_CONFIG_EVEN_PARITY_LSB_POSN       = (int)2,
   UART_CONFIG_UART_CONFIG_EVEN_PARITY_MSB_POSN       = (int)2,
   UART_CONFIG_FLOW_CTRL_EN_POSN                      = (int)3,
   UART_CONFIG_UART_CONFIG_FLOW_CTRL_EN_LSB_POSN      = (int)3,
   UART_CONFIG_UART_CONFIG_FLOW_CTRL_EN_MSB_POSN      = (int)3,
   UART_CONFIG_RTS_AUTO_EN_POSN                       = (int)4,
   UART_CONFIG_UART_CONFIG_RTS_AUTO_EN_LSB_POSN       = (int)4,
   UART_CONFIG_UART_CONFIG_RTS_AUTO_EN_MSB_POSN       = (int)4,
   UART_CONFIG_RTS_POSN                               = (int)5,
   UART_CONFIG_UART_CONFIG_RTS_LSB_POSN               = (int)5,
   UART_CONFIG_UART_CONFIG_RTS_MSB_POSN               = (int)5,
   UART_CONFIG_TX_ZERO_EN_POSN                        = (int)6,
   UART_CONFIG_UART_CONFIG_TX_ZERO_EN_LSB_POSN        = (int)6,
   UART_CONFIG_UART_CONFIG_TX_ZERO_EN_MSB_POSN        = (int)6,
   UART_CONFIG_RX_OFFSET_EN_POSN                      = (int)7,
   UART_CONFIG_UART_CONFIG_RX_OFFSET_EN_LSB_POSN      = (int)7,
   UART_CONFIG_UART_CONFIG_RX_OFFSET_EN_MSB_POSN      = (int)7,
   UART_CONFIG_PHY_CLK_DIV_LSB_POSN                   = (int)8,
   UART_CONFIG_UART_CONFIG_PHY_CLK_DIV_LSB_POSN       = (int)8,
   UART_CONFIG_PHY_CLK_DIV_MSB_POSN                   = (int)9,
   UART_CONFIG_UART_CONFIG_PHY_CLK_DIV_MSB_POSN       = (int)9
};
typedef enum uart_config_posn_enum uart_config_posn;

#define UART_CONFIG_TWO_STOP_BITS_MASK           (0x00000001u)
#define UART_CONFIG_ONE_PARITY_BIT_MASK          (0x00000002u)
#define UART_CONFIG_EVEN_PARITY_MASK             (0x00000004u)
#define UART_CONFIG_FLOW_CTRL_EN_MASK            (0x00000008u)
#define UART_CONFIG_RTS_AUTO_EN_MASK             (0x00000010u)
#define UART_CONFIG_RTS_MASK                     (0x00000020u)
#define UART_CONFIG_TX_ZERO_EN_MASK              (0x00000040u)
#define UART_CONFIG_RX_OFFSET_EN_MASK            (0x00000080u)
#define UART_CONFIG_PHY_CLK_DIV_LSB_MASK         (0x00000100u)
#define UART_CONFIG_PHY_CLK_DIV_MSB_MASK         (0x00000200u)

enum uart_curator_reg_access_control_posn_enum
{
   UART_CURATOR_REG_ACCESS_CONTROL_OTHER_SSID_LSB_POSN = (int)0,
   UART_CURATOR_REG_ACCESS_CONTROL_UART_CURATOR_REG_ACCESS_CONTROL_OTHER_SSID_LSB_POSN = (int)0,
   UART_CURATOR_REG_ACCESS_CONTROL_OTHER_SSID_MSB_POSN = (int)3,
   UART_CURATOR_REG_ACCESS_CONTROL_UART_CURATOR_REG_ACCESS_CONTROL_OTHER_SSID_MSB_POSN = (int)3,
   UART_CURATOR_REG_ACCESS_CONTROL_ACCESS_OTHER_SS_REGS_POSN = (int)4,
   UART_CURATOR_REG_ACCESS_CONTROL_UART_CURATOR_REG_ACCESS_CONTROL_ACCESS_OTHER_SS_REGS_LSB_POSN = (int)4,
   UART_CURATOR_REG_ACCESS_CONTROL_UART_CURATOR_REG_ACCESS_CONTROL_ACCESS_OTHER_SS_REGS_MSB_POSN = (int)4
};
typedef enum uart_curator_reg_access_control_posn_enum uart_curator_reg_access_control_posn;

#define UART_CURATOR_REG_ACCESS_CONTROL_OTHER_SSID_LSB_MASK (0x00000001u)
#define UART_CURATOR_REG_ACCESS_CONTROL_OTHER_SSID_MSB_MASK (0x00000008u)
#define UART_CURATOR_REG_ACCESS_CONTROL_ACCESS_OTHER_SS_REGS_MASK (0x00000010u)

enum uart_event_reporting_error_status_posn_enum
{
   EVENT_REPORTING_ERROR_FLAG_POSN                    = (int)0,
   UART_EVENT_REPORTING_ERROR_STATUS_EVENT_REPORTING_ERROR_FLAG_LSB_POSN = (int)0,
   UART_EVENT_REPORTING_ERROR_STATUS_EVENT_REPORTING_ERROR_FLAG_MSB_POSN = (int)0,
   EVENT_REPORTING_ERROR_OVERFLOW_NOT_VML_POSN        = (int)1,
   UART_EVENT_REPORTING_ERROR_STATUS_EVENT_REPORTING_ERROR_OVERFLOW_NOT_VML_LSB_POSN = (int)1,
   UART_EVENT_REPORTING_ERROR_STATUS_EVENT_REPORTING_ERROR_OVERFLOW_NOT_VML_MSB_POSN = (int)1,
   EVENT_REPORTING_ERROR_EVENT_GROUP_LSB_POSN         = (int)2,
   UART_EVENT_REPORTING_ERROR_STATUS_EVENT_REPORTING_ERROR_EVENT_GROUP_LSB_POSN = (int)2,
   EVENT_REPORTING_ERROR_EVENT_GROUP_MSB_POSN         = (int)4,
   UART_EVENT_REPORTING_ERROR_STATUS_EVENT_REPORTING_ERROR_EVENT_GROUP_MSB_POSN = (int)4,
   EVENT_REPORTING_ERROR_SSID_LSB_POSN                = (int)5,
   UART_EVENT_REPORTING_ERROR_STATUS_EVENT_REPORTING_ERROR_SSID_LSB_POSN = (int)5,
   EVENT_REPORTING_ERROR_SSID_MSB_POSN                = (int)8,
   UART_EVENT_REPORTING_ERROR_STATUS_EVENT_REPORTING_ERROR_SSID_MSB_POSN = (int)8,
   EVENT_REPORTING_ERROR_VML_CODE_LSB_POSN            = (int)9,
   UART_EVENT_REPORTING_ERROR_STATUS_EVENT_REPORTING_ERROR_VML_CODE_LSB_POSN = (int)9,
   EVENT_REPORTING_ERROR_VML_CODE_MSB_POSN            = (int)12,
   UART_EVENT_REPORTING_ERROR_STATUS_EVENT_REPORTING_ERROR_VML_CODE_MSB_POSN = (int)12
};
typedef enum uart_event_reporting_error_status_posn_enum uart_event_reporting_error_status_posn;

#define EVENT_REPORTING_ERROR_FLAG_MASK          (0x00000001u)
#define EVENT_REPORTING_ERROR_OVERFLOW_NOT_VML_MASK (0x00000002u)
#define EVENT_REPORTING_ERROR_EVENT_GROUP_LSB_MASK (0x00000004u)
#define EVENT_REPORTING_ERROR_EVENT_GROUP_MSB_MASK (0x00000010u)
#define EVENT_REPORTING_ERROR_SSID_LSB_MASK      (0x00000020u)
#define EVENT_REPORTING_ERROR_SSID_MSB_MASK      (0x00000100u)
#define EVENT_REPORTING_ERROR_VML_CODE_LSB_MASK  (0x00000200u)
#define EVENT_REPORTING_ERROR_VML_CODE_MSB_MASK  (0x00001000u)

enum uart_rate_enum
{
   UART_RATE_9K6                            = (int)0x14,
   UART_RATE_19K2                           = (int)0x27,
   UART_RATE_38K4                           = (int)0x4F,
   UART_RATE_57K6                           = (int)0x76,
   UART_RATE_115K2                          = (int)0xEC,
   UART_RATE_230K4                          = (int)0x1D8,
   UART_RATE_460K8                          = (int)0x3B0,
   UART_RATE_921K6                          = (int)0x75F,
   UART_RATE_1382K4                         = (int)0xB0F,
   UART_RATE_1843K2                         = (int)0xEBF,
   UART_RATE_2764K8                         = (int)0x161E,
   UART_RATE_3686K4                         = (int)0x1D7E,
   UART_RATE_5529K6                         = (int)0x2C3D,
   MAX_UART_RATE                            = (int)0x2C3D
};
typedef enum uart_rate_enum uart_rate;


enum uart_sru_control_posn_enum
{
   SRU_CONTROL_SRU_LSB_POSN                           = (int)0,
   UART_SRU_CONTROL_SRU_CONTROL_SRU_LSB_POSN          = (int)0,
   SRU_CONTROL_SRU_MSB_POSN                           = (int)3,
   UART_SRU_CONTROL_SRU_CONTROL_SRU_MSB_POSN          = (int)3,
   SRU_CONTROL_SSID_LSB_POSN                          = (int)4,
   UART_SRU_CONTROL_SRU_CONTROL_SSID_LSB_POSN         = (int)4,
   SRU_CONTROL_SSID_MSB_POSN                          = (int)7,
   UART_SRU_CONTROL_SRU_CONTROL_SSID_MSB_POSN         = (int)7
};
typedef enum uart_sru_control_posn_enum uart_sru_control_posn;

#define SRU_CONTROL_SRU_LSB_MASK                 (0x00000001u)
#define SRU_CONTROL_SRU_MSB_MASK                 (0x00000008u)
#define SRU_CONTROL_SSID_LSB_MASK                (0x00000010u)
#define SRU_CONTROL_SSID_MSB_MASK                (0x00000080u)

enum uart_status_posn_enum
{
   UART_STATUS_CTS_POSN                               = (int)0,
   UART_STATUS_UART_STATUS_CTS_LSB_POSN               = (int)0,
   UART_STATUS_UART_STATUS_CTS_MSB_POSN               = (int)0,
   UART_STATUS_DATA_IN_POSN                           = (int)1,
   UART_STATUS_UART_STATUS_DATA_IN_LSB_POSN           = (int)1,
   UART_STATUS_UART_STATUS_DATA_IN_MSB_POSN           = (int)1,
   UART_STATUS_TX_BYTE_IN_PROGRESS_POSN               = (int)2,
   UART_STATUS_UART_STATUS_TX_BYTE_IN_PROGRESS_LSB_POSN = (int)2,
   UART_STATUS_UART_STATUS_TX_BYTE_IN_PROGRESS_MSB_POSN = (int)2,
   UART_STATUS_RX_BYTE_IN_PROGRESS_POSN               = (int)3,
   UART_STATUS_UART_STATUS_RX_BYTE_IN_PROGRESS_LSB_POSN = (int)3,
   UART_STATUS_UART_STATUS_RX_BYTE_IN_PROGRESS_MSB_POSN = (int)3,
   UART_STATUS_SEARCH_SEQUENCE_POSN                   = (int)4,
   UART_STATUS_UART_STATUS_SEARCH_SEQUENCE_LSB_POSN   = (int)4,
   UART_STATUS_UART_STATUS_SEARCH_SEQUENCE_MSB_POSN   = (int)4
};
typedef enum uart_status_posn_enum uart_status_posn;

#define UART_STATUS_CTS_MASK                     (0x00000001u)
#define UART_STATUS_DATA_IN_MASK                 (0x00000002u)
#define UART_STATUS_TX_BYTE_IN_PROGRESS_MASK     (0x00000004u)
#define UART_STATUS_RX_BYTE_IN_PROGRESS_MASK     (0x00000008u)
#define UART_STATUS_SEARCH_SEQUENCE_MASK         (0x00000010u)

enum uart_tx_td_ctrl_posn_enum
{
   TD_CTRL_Q1_NOT_Q0_POSN                             = (int)0,
   UART_TX_TD_CTRL_TD_CTRL_Q1_NOT_Q0_LSB_POSN         = (int)0,
   UART_TX_TD_CTRL_TD_CTRL_Q1_NOT_Q0_MSB_POSN         = (int)0,
   TD_CTRL_ADD_TD_POSN                                = (int)1,
   UART_TX_TD_CTRL_TD_CTRL_ADD_TD_LSB_POSN            = (int)1,
   UART_TX_TD_CTRL_TD_CTRL_ADD_TD_MSB_POSN            = (int)1,
   TD_CTRL_CLEAR_POSN                                 = (int)2,
   UART_TX_TD_CTRL_TD_CTRL_CLEAR_LSB_POSN             = (int)2,
   UART_TX_TD_CTRL_TD_CTRL_CLEAR_MSB_POSN             = (int)2,
   TD_CTRL_ABORT_POSN                                 = (int)3,
   UART_TX_TD_CTRL_TD_CTRL_ABORT_LSB_POSN             = (int)3,
   UART_TX_TD_CTRL_TD_CTRL_ABORT_MSB_POSN             = (int)3
};
typedef enum uart_tx_td_ctrl_posn_enum uart_tx_td_ctrl_posn;

#define TD_CTRL_Q1_NOT_Q0_MASK                   (0x00000001u)
#define TD_CTRL_ADD_TD_MASK                      (0x00000002u)
#define TD_CTRL_CLEAR_MASK                       (0x00000004u)
#define TD_CTRL_ABORT_MASK                       (0x00000008u)

enum uart_tx_td_global_ctrl_posn_enum
{
   TD_CTRL_GLOBAL_CLEAR_ALL_POSN                      = (int)0,
   UART_TX_TD_GLOBAL_CTRL_TD_CTRL_GLOBAL_CLEAR_ALL_LSB_POSN = (int)0,
   UART_TX_TD_GLOBAL_CTRL_TD_CTRL_GLOBAL_CLEAR_ALL_MSB_POSN = (int)0,
   TD_CTRL_GLOBAL_ABORT_ALL_POSN                      = (int)1,
   UART_TX_TD_GLOBAL_CTRL_TD_CTRL_GLOBAL_ABORT_ALL_LSB_POSN = (int)1,
   UART_TX_TD_GLOBAL_CTRL_TD_CTRL_GLOBAL_ABORT_ALL_MSB_POSN = (int)1
};
typedef enum uart_tx_td_global_ctrl_posn_enum uart_tx_td_global_ctrl_posn;

#define TD_CTRL_GLOBAL_CLEAR_ALL_MASK            (0x00000001u)
#define TD_CTRL_GLOBAL_ABORT_ALL_MASK            (0x00000002u)

enum uart_bcsp_rx_prot_id_read_select_posn_enum
{
   UART_BCSP_RX_PROT_ID_READ_SELECT_LSB_POSN          = (int)0,
   UART_BCSP_RX_PROT_ID_READ_SELECT_UART_BCSP_RX_PROT_ID_READ_SELECT_LSB_POSN = (int)0,
   UART_BCSP_RX_PROT_ID_READ_SELECT_MSB_POSN          = (int)3,
   UART_BCSP_RX_PROT_ID_READ_SELECT_UART_BCSP_RX_PROT_ID_READ_SELECT_MSB_POSN = (int)3
};
typedef enum uart_bcsp_rx_prot_id_read_select_posn_enum uart_bcsp_rx_prot_id_read_select_posn;

#define UART_BCSP_RX_PROT_ID_READ_SELECT_LSB_MASK (0x00000001u)
#define UART_BCSP_RX_PROT_ID_READ_SELECT_MSB_MASK (0x00000008u)

enum uart_bcsp_rx_seq_mode_is_per_prot_id_posn_enum
{
   UART_BCSP_RX_SEQ_MODE_IS_PER_PROT_ID_POSN          = (int)0,
   UART_BCSP_RX_SEQ_MODE_IS_PER_PROT_ID_UART_BCSP_RX_SEQ_MODE_IS_PER_PROT_ID_LSB_POSN = (int)0,
   UART_BCSP_RX_SEQ_MODE_IS_PER_PROT_ID_UART_BCSP_RX_SEQ_MODE_IS_PER_PROT_ID_MSB_POSN = (int)0
};
typedef enum uart_bcsp_rx_seq_mode_is_per_prot_id_posn_enum uart_bcsp_rx_seq_mode_is_per_prot_id_posn;

#define UART_BCSP_RX_SEQ_MODE_IS_PER_PROT_ID_MASK (0x00000001u)

enum uart_common_regs_ss_write_enable_posn_enum
{
   UART_COMMON_REGS_SS_WRITE_ENABLE_LSB_POSN          = (int)0,
   UART_COMMON_REGS_SS_WRITE_ENABLE_UART_COMMON_REGS_SS_WRITE_ENABLE_LSB_POSN = (int)0,
   UART_COMMON_REGS_SS_WRITE_ENABLE_MSB_POSN          = (int)15,
   UART_COMMON_REGS_SS_WRITE_ENABLE_UART_COMMON_REGS_SS_WRITE_ENABLE_MSB_POSN = (int)15
};
typedef enum uart_common_regs_ss_write_enable_posn_enum uart_common_regs_ss_write_enable_posn;

#define UART_COMMON_REGS_SS_WRITE_ENABLE_LSB_MASK (0x00000001u)
#define UART_COMMON_REGS_SS_WRITE_ENABLE_MSB_MASK (0x00008000u)

enum uart_curator_ssid_posn_enum
{
   UART_CURATOR_SSID_LSB_POSN                         = (int)0,
   UART_CURATOR_SSID_UART_CURATOR_SSID_LSB_POSN       = (int)0,
   UART_CURATOR_SSID_MSB_POSN                         = (int)3,
   UART_CURATOR_SSID_UART_CURATOR_SSID_MSB_POSN       = (int)3
};
typedef enum uart_curator_ssid_posn_enum uart_curator_ssid_posn;

#define UART_CURATOR_SSID_LSB_MASK               (0x00000001u)
#define UART_CURATOR_SSID_MSB_MASK               (0x00000008u)

enum uart_debug_select_posn_enum
{
   UART_DEBUG_SELECT_LSB_POSN                         = (int)0,
   UART_DEBUG_SELECT_UART_DEBUG_SELECT_LSB_POSN       = (int)0,
   UART_DEBUG_SELECT_MSB_POSN                         = (int)4,
   UART_DEBUG_SELECT_UART_DEBUG_SELECT_MSB_POSN       = (int)4
};
typedef enum uart_debug_select_posn_enum uart_debug_select_posn;

#define UART_DEBUG_SELECT_LSB_MASK               (0x00000001u)
#define UART_DEBUG_SELECT_MSB_MASK               (0x00000010u)

enum uart_debug_status_posn_enum
{
   UART_DEBUG_STATUS_LSB_POSN                         = (int)0,
   UART_DEBUG_STATUS_UART_DEBUG_STATUS_LSB_POSN       = (int)0,
   UART_DEBUG_STATUS_MSB_POSN                         = (int)15,
   UART_DEBUG_STATUS_UART_DEBUG_STATUS_MSB_POSN       = (int)15
};
typedef enum uart_debug_status_posn_enum uart_debug_status_posn;

#define UART_DEBUG_STATUS_LSB_MASK               (0x00000001u)
#define UART_DEBUG_STATUS_MSB_MASK               (0x00008000u)

enum uart_event_reporting_error_status_clear_posn_enum
{
   UART_EVENT_REPORTING_ERROR_STATUS_CLEAR_POSN       = (int)0,
   UART_EVENT_REPORTING_ERROR_STATUS_CLEAR_UART_EVENT_REPORTING_ERROR_STATUS_CLEAR_LSB_POSN = (int)0,
   UART_EVENT_REPORTING_ERROR_STATUS_CLEAR_UART_EVENT_REPORTING_ERROR_STATUS_CLEAR_MSB_POSN = (int)0
};
typedef enum uart_event_reporting_error_status_clear_posn_enum uart_event_reporting_error_status_clear_posn;

#define UART_EVENT_REPORTING_ERROR_STATUS_CLEAR_MASK (0x00000001u)

enum uart_event_reporting_soft_reset_posn_enum
{
   UART_EVENT_REPORTING_SOFT_RESET_POSN               = (int)0,
   UART_EVENT_REPORTING_SOFT_RESET_UART_EVENT_REPORTING_SOFT_RESET_LSB_POSN = (int)0,
   UART_EVENT_REPORTING_SOFT_RESET_UART_EVENT_REPORTING_SOFT_RESET_MSB_POSN = (int)0
};
typedef enum uart_event_reporting_soft_reset_posn_enum uart_event_reporting_soft_reset_posn;

#define UART_EVENT_REPORTING_SOFT_RESET_MASK     (0x00000001u)

enum uart_evt_desc_cc_curator_enable_posn_enum
{
   UART_EVT_DESC_CC_CURATOR_ENABLE_LSB_POSN           = (int)0,
   UART_EVT_DESC_CC_CURATOR_ENABLE_UART_EVT_DESC_CC_CURATOR_ENABLE_LSB_POSN = (int)0,
   UART_EVT_DESC_CC_CURATOR_ENABLE_MSB_POSN           = (int)15,
   UART_EVT_DESC_CC_CURATOR_ENABLE_UART_EVT_DESC_CC_CURATOR_ENABLE_MSB_POSN = (int)15
};
typedef enum uart_evt_desc_cc_curator_enable_posn_enum uart_evt_desc_cc_curator_enable_posn;

#define UART_EVT_DESC_CC_CURATOR_ENABLE_LSB_MASK (0x00000001u)
#define UART_EVT_DESC_CC_CURATOR_ENABLE_MSB_MASK (0x00008000u)

enum uart_evt_desc_cc_curator_evt_enable_posn_enum
{
   UART_EVT_DESC_CC_CURATOR_EVT_ENABLE_LSB_POSN       = (int)0,
   UART_EVT_DESC_CC_CURATOR_EVT_ENABLE_UART_EVT_DESC_CC_CURATOR_EVT_ENABLE_LSB_POSN = (int)0,
   UART_EVT_DESC_CC_CURATOR_EVT_ENABLE_MSB_POSN       = (int)10,
   UART_EVT_DESC_CC_CURATOR_EVT_ENABLE_UART_EVT_DESC_CC_CURATOR_EVT_ENABLE_MSB_POSN = (int)10
};
typedef enum uart_evt_desc_cc_curator_evt_enable_posn_enum uart_evt_desc_cc_curator_evt_enable_posn;

#define UART_EVT_DESC_CC_CURATOR_EVT_ENABLE_LSB_MASK (0x00000001u)
#define UART_EVT_DESC_CC_CURATOR_EVT_ENABLE_MSB_MASK (0x00000400u)

enum uart_interrupt_cc_curator_enable_posn_enum
{
   UART_INTERRUPT_CC_CURATOR_ENABLE_LSB_POSN          = (int)0,
   UART_INTERRUPT_CC_CURATOR_ENABLE_UART_INTERRUPT_CC_CURATOR_ENABLE_LSB_POSN = (int)0,
   UART_INTERRUPT_CC_CURATOR_ENABLE_MSB_POSN          = (int)15,
   UART_INTERRUPT_CC_CURATOR_ENABLE_UART_INTERRUPT_CC_CURATOR_ENABLE_MSB_POSN = (int)15
};
typedef enum uart_interrupt_cc_curator_enable_posn_enum uart_interrupt_cc_curator_enable_posn;

#define UART_INTERRUPT_CC_CURATOR_ENABLE_LSB_MASK (0x00000001u)
#define UART_INTERRUPT_CC_CURATOR_ENABLE_MSB_MASK (0x00008000u)

enum uart_interrupt_cc_curator_evt_enable_posn_enum
{
   UART_INTERRUPT_CC_CURATOR_EVT_ENABLE_LSB_POSN      = (int)0,
   UART_INTERRUPT_CC_CURATOR_EVT_ENABLE_UART_INTERRUPT_CC_CURATOR_EVT_ENABLE_LSB_POSN = (int)0,
   UART_INTERRUPT_CC_CURATOR_EVT_ENABLE_MSB_POSN      = (int)10,
   UART_INTERRUPT_CC_CURATOR_EVT_ENABLE_UART_INTERRUPT_CC_CURATOR_EVT_ENABLE_MSB_POSN = (int)10
};
typedef enum uart_interrupt_cc_curator_evt_enable_posn_enum uart_interrupt_cc_curator_evt_enable_posn;

#define UART_INTERRUPT_CC_CURATOR_EVT_ENABLE_LSB_MASK (0x00000001u)
#define UART_INTERRUPT_CC_CURATOR_EVT_ENABLE_MSB_MASK (0x00000400u)

enum uart_no_activity_countdown_posn_enum
{
   UART_NO_ACTIVITY_COUNTDOWN_LSB_POSN                = (int)0,
   UART_NO_ACTIVITY_COUNTDOWN_UART_NO_ACTIVITY_COUNTDOWN_LSB_POSN = (int)0,
   UART_NO_ACTIVITY_COUNTDOWN_MSB_POSN                = (int)15,
   UART_NO_ACTIVITY_COUNTDOWN_UART_NO_ACTIVITY_COUNTDOWN_MSB_POSN = (int)15
};
typedef enum uart_no_activity_countdown_posn_enum uart_no_activity_countdown_posn;

#define UART_NO_ACTIVITY_COUNTDOWN_LSB_MASK      (0x00000001u)
#define UART_NO_ACTIVITY_COUNTDOWN_MSB_MASK      (0x00008000u)

enum uart_no_activity_detector_posn_enum
{
   UART_NO_ACTIVITY_DETECTOR_LSB_POSN                 = (int)0,
   UART_NO_ACTIVITY_DETECTOR_UART_NO_ACTIVITY_DETECTOR_LSB_POSN = (int)0,
   UART_NO_ACTIVITY_DETECTOR_MSB_POSN                 = (int)15,
   UART_NO_ACTIVITY_DETECTOR_UART_NO_ACTIVITY_DETECTOR_MSB_POSN = (int)15
};
typedef enum uart_no_activity_detector_posn_enum uart_no_activity_detector_posn;

#define UART_NO_ACTIVITY_DETECTOR_LSB_MASK       (0x00000001u)
#define UART_NO_ACTIVITY_DETECTOR_MSB_MASK       (0x00008000u)

enum uart_num_subsys_supported_posn_enum
{
   UART_NUM_SUBSYS_SUPPORTED_LSB_POSN                 = (int)0,
   UART_NUM_SUBSYS_SUPPORTED_UART_NUM_SUBSYS_SUPPORTED_LSB_POSN = (int)0,
   UART_NUM_SUBSYS_SUPPORTED_MSB_POSN                 = (int)4,
   UART_NUM_SUBSYS_SUPPORTED_UART_NUM_SUBSYS_SUPPORTED_MSB_POSN = (int)4
};
typedef enum uart_num_subsys_supported_posn_enum uart_num_subsys_supported_posn;

#define UART_NUM_SUBSYS_SUPPORTED_LSB_MASK       (0x00000001u)
#define UART_NUM_SUBSYS_SUPPORTED_MSB_MASK       (0x00000010u)

enum uart_rst_delay_posn_enum
{
   UART_RST_DELAY_LSB_POSN                            = (int)0,
   UART_RST_DELAY_UART_RST_DELAY_LSB_POSN             = (int)0,
   UART_RST_DELAY_MSB_POSN                            = (int)9,
   UART_RST_DELAY_UART_RST_DELAY_MSB_POSN             = (int)9
};
typedef enum uart_rst_delay_posn_enum uart_rst_delay_posn;

#define UART_RST_DELAY_LSB_MASK                  (0x00000001u)
#define UART_RST_DELAY_MSB_MASK                  (0x00000200u)

enum uart_rst_en_posn_enum
{
   UART_RST_EN_POSN                                   = (int)0,
   UART_RST_EN_UART_RST_EN_LSB_POSN                   = (int)0,
   UART_RST_EN_UART_RST_EN_MSB_POSN                   = (int)0
};
typedef enum uart_rst_en_posn_enum uart_rst_en_posn;

#define UART_RST_EN_MASK                         (0x00000001u)

enum uart_rx_default_ssid_posn_enum
{
   UART_RX_DEFAULT_SSID_LSB_POSN                      = (int)0,
   UART_RX_DEFAULT_SSID_UART_RX_DEFAULT_SSID_LSB_POSN = (int)0,
   UART_RX_DEFAULT_SSID_MSB_POSN                      = (int)3,
   UART_RX_DEFAULT_SSID_UART_RX_DEFAULT_SSID_MSB_POSN = (int)3
};
typedef enum uart_rx_default_ssid_posn_enum uart_rx_default_ssid_posn;

#define UART_RX_DEFAULT_SSID_LSB_MASK            (0x00000001u)
#define UART_RX_DEFAULT_SSID_MSB_MASK            (0x00000008u)

enum uart_rx_enable_posn_enum
{
   UART_RX_ENABLE_POSN                                = (int)0,
   UART_RX_ENABLE_UART_RX_ENABLE_LSB_POSN             = (int)0,
   UART_RX_ENABLE_UART_RX_ENABLE_MSB_POSN             = (int)0
};
typedef enum uart_rx_enable_posn_enum uart_rx_enable_posn;

#define UART_RX_ENABLE_MASK                      (0x00000001u)

enum uart_rx_force_end_of_packet_posn_enum
{
   UART_RX_FORCE_END_OF_PACKET_POSN                   = (int)0,
   UART_RX_FORCE_END_OF_PACKET_UART_RX_FORCE_END_OF_PACKET_LSB_POSN = (int)0,
   UART_RX_FORCE_END_OF_PACKET_UART_RX_FORCE_END_OF_PACKET_MSB_POSN = (int)0
};
typedef enum uart_rx_force_end_of_packet_posn_enum uart_rx_force_end_of_packet_posn;

#define UART_RX_FORCE_END_OF_PACKET_MASK         (0x00000001u)

enum uart_rx_idle_timeout_posn_enum
{
   UART_RX_IDLE_TIMEOUT_LSB_POSN                      = (int)0,
   UART_RX_IDLE_TIMEOUT_UART_RX_IDLE_TIMEOUT_LSB_POSN = (int)0,
   UART_RX_IDLE_TIMEOUT_MSB_POSN                      = (int)9,
   UART_RX_IDLE_TIMEOUT_UART_RX_IDLE_TIMEOUT_MSB_POSN = (int)9
};
typedef enum uart_rx_idle_timeout_posn_enum uart_rx_idle_timeout_posn;

#define UART_RX_IDLE_TIMEOUT_LSB_MASK            (0x00000001u)
#define UART_RX_IDLE_TIMEOUT_MSB_MASK            (0x00000200u)

enum uart_rx_packet_timeout_posn_enum
{
   UART_RX_PACKET_TIMEOUT_LSB_POSN                    = (int)0,
   UART_RX_PACKET_TIMEOUT_UART_RX_PACKET_TIMEOUT_LSB_POSN = (int)0,
   UART_RX_PACKET_TIMEOUT_MSB_POSN                    = (int)15,
   UART_RX_PACKET_TIMEOUT_UART_RX_PACKET_TIMEOUT_MSB_POSN = (int)15
};
typedef enum uart_rx_packet_timeout_posn_enum uart_rx_packet_timeout_posn;

#define UART_RX_PACKET_TIMEOUT_LSB_MASK          (0x00000001u)
#define UART_RX_PACKET_TIMEOUT_MSB_MASK          (0x00008000u)

enum uart_rx_protocol_none_transfer_length_posn_enum
{
   UART_RX_PROTOCOL_NONE_TRANSFER_LENGTH_LSB_POSN     = (int)0,
   UART_RX_PROTOCOL_NONE_TRANSFER_LENGTH_UART_RX_PROTOCOL_NONE_TRANSFER_LENGTH_LSB_POSN = (int)0,
   UART_RX_PROTOCOL_NONE_TRANSFER_LENGTH_MSB_POSN     = (int)15,
   UART_RX_PROTOCOL_NONE_TRANSFER_LENGTH_UART_RX_PROTOCOL_NONE_TRANSFER_LENGTH_MSB_POSN = (int)15
};
typedef enum uart_rx_protocol_none_transfer_length_posn_enum uart_rx_protocol_none_transfer_length_posn;

#define UART_RX_PROTOCOL_NONE_TRANSFER_LENGTH_LSB_MASK (0x00000001u)
#define UART_RX_PROTOCOL_NONE_TRANSFER_LENGTH_MSB_MASK (0x00008000u)

enum uart_rx_soft_reset_posn_enum
{
   UART_RX_SOFT_RESET_POSN                            = (int)0,
   UART_RX_SOFT_RESET_UART_RX_SOFT_RESET_LSB_POSN     = (int)0,
   UART_RX_SOFT_RESET_UART_RX_SOFT_RESET_MSB_POSN     = (int)0
};
typedef enum uart_rx_soft_reset_posn_enum uart_rx_soft_reset_posn;

#define UART_RX_SOFT_RESET_MASK                  (0x00000001u)

enum uart_search_sequence_0_posn_enum
{
   UART_SEARCH_SEQUENCE_0_LSB_POSN                    = (int)0,
   UART_SEARCH_SEQUENCE_0_UART_SEARCH_SEQUENCE_0_LSB_POSN = (int)0,
   UART_SEARCH_SEQUENCE_0_MSB_POSN                    = (int)7,
   UART_SEARCH_SEQUENCE_0_UART_SEARCH_SEQUENCE_0_MSB_POSN = (int)7
};
typedef enum uart_search_sequence_0_posn_enum uart_search_sequence_0_posn;

#define UART_SEARCH_SEQUENCE_0_LSB_MASK          (0x00000001u)
#define UART_SEARCH_SEQUENCE_0_MSB_MASK          (0x00000080u)

enum uart_search_sequence_1_posn_enum
{
   UART_SEARCH_SEQUENCE_1_LSB_POSN                    = (int)0,
   UART_SEARCH_SEQUENCE_1_UART_SEARCH_SEQUENCE_1_LSB_POSN = (int)0,
   UART_SEARCH_SEQUENCE_1_MSB_POSN                    = (int)7,
   UART_SEARCH_SEQUENCE_1_UART_SEARCH_SEQUENCE_1_MSB_POSN = (int)7
};
typedef enum uart_search_sequence_1_posn_enum uart_search_sequence_1_posn;

#define UART_SEARCH_SEQUENCE_1_LSB_MASK          (0x00000001u)
#define UART_SEARCH_SEQUENCE_1_MSB_MASK          (0x00000080u)

enum uart_search_sequence_2_posn_enum
{
   UART_SEARCH_SEQUENCE_2_LSB_POSN                    = (int)0,
   UART_SEARCH_SEQUENCE_2_UART_SEARCH_SEQUENCE_2_LSB_POSN = (int)0,
   UART_SEARCH_SEQUENCE_2_MSB_POSN                    = (int)7,
   UART_SEARCH_SEQUENCE_2_UART_SEARCH_SEQUENCE_2_MSB_POSN = (int)7
};
typedef enum uart_search_sequence_2_posn_enum uart_search_sequence_2_posn;

#define UART_SEARCH_SEQUENCE_2_LSB_MASK          (0x00000001u)
#define UART_SEARCH_SEQUENCE_2_MSB_MASK          (0x00000080u)

enum uart_search_sequence_3_posn_enum
{
   UART_SEARCH_SEQUENCE_3_LSB_POSN                    = (int)0,
   UART_SEARCH_SEQUENCE_3_UART_SEARCH_SEQUENCE_3_LSB_POSN = (int)0,
   UART_SEARCH_SEQUENCE_3_MSB_POSN                    = (int)7,
   UART_SEARCH_SEQUENCE_3_UART_SEARCH_SEQUENCE_3_MSB_POSN = (int)7
};
typedef enum uart_search_sequence_3_posn_enum uart_search_sequence_3_posn;

#define UART_SEARCH_SEQUENCE_3_LSB_MASK          (0x00000001u)
#define UART_SEARCH_SEQUENCE_3_MSB_MASK          (0x00000080u)

enum uart_search_sequence_length_posn_enum
{
   UART_SEARCH_SEQUENCE_LENGTH_LSB_POSN               = (int)0,
   UART_SEARCH_SEQUENCE_LENGTH_UART_SEARCH_SEQUENCE_LENGTH_LSB_POSN = (int)0,
   UART_SEARCH_SEQUENCE_LENGTH_MSB_POSN               = (int)2,
   UART_SEARCH_SEQUENCE_LENGTH_UART_SEARCH_SEQUENCE_LENGTH_MSB_POSN = (int)2
};
typedef enum uart_search_sequence_length_posn_enum uart_search_sequence_length_posn;

#define UART_SEARCH_SEQUENCE_LENGTH_LSB_MASK     (0x00000001u)
#define UART_SEARCH_SEQUENCE_LENGTH_MSB_MASK     (0x00000004u)

enum uart_tx_enable_posn_enum
{
   UART_TX_ENABLE_POSN                                = (int)0,
   UART_TX_ENABLE_UART_TX_ENABLE_LSB_POSN             = (int)0,
   UART_TX_ENABLE_UART_TX_ENABLE_MSB_POSN             = (int)0
};
typedef enum uart_tx_enable_posn_enum uart_tx_enable_posn;

#define UART_TX_ENABLE_MASK                      (0x00000001u)

enum uart_tx_soft_reset_posn_enum
{
   UART_TX_SOFT_RESET_POSN                            = (int)0,
   UART_TX_SOFT_RESET_UART_TX_SOFT_RESET_LSB_POSN     = (int)0,
   UART_TX_SOFT_RESET_UART_TX_SOFT_RESET_MSB_POSN     = (int)0
};
typedef enum uart_tx_soft_reset_posn_enum uart_tx_soft_reset_posn;

#define UART_TX_SOFT_RESET_MASK                  (0x00000001u)

enum uart_tx_tdq0_disable_posn_enum
{
   UART_TX_TDQ0_DISABLE_LSB_POSN                      = (int)0,
   UART_TX_TDQ0_DISABLE_UART_TX_TDQ0_DISABLE_LSB_POSN = (int)0,
   UART_TX_TDQ0_DISABLE_MSB_POSN                      = (int)15,
   UART_TX_TDQ0_DISABLE_UART_TX_TDQ0_DISABLE_MSB_POSN = (int)15
};
typedef enum uart_tx_tdq0_disable_posn_enum uart_tx_tdq0_disable_posn;

#define UART_TX_TDQ0_DISABLE_LSB_MASK            (0x00000001u)
#define UART_TX_TDQ0_DISABLE_MSB_MASK            (0x00008000u)

enum uart_tx_tdq1_disable_posn_enum
{
   UART_TX_TDQ1_DISABLE_LSB_POSN                      = (int)0,
   UART_TX_TDQ1_DISABLE_UART_TX_TDQ1_DISABLE_LSB_POSN = (int)0,
   UART_TX_TDQ1_DISABLE_MSB_POSN                      = (int)15,
   UART_TX_TDQ1_DISABLE_UART_TX_TDQ1_DISABLE_MSB_POSN = (int)15
};
typedef enum uart_tx_tdq1_disable_posn_enum uart_tx_tdq1_disable_posn;

#define UART_TX_TDQ1_DISABLE_LSB_MASK            (0x00000001u)
#define UART_TX_TDQ1_DISABLE_MSB_MASK            (0x00008000u)

enum uart_protocol_mapping_00_posn_enum
{
   UART_PROTOCOL_MAPPING_00_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_00_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_00_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_00_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_00_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_00_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_00_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_00_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_00_posn_enum uart_protocol_mapping_00_posn;


enum uart_protocol_mapping_01_posn_enum
{
   UART_PROTOCOL_MAPPING_01_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_01_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_01_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_01_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_01_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_01_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_01_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_01_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_01_posn_enum uart_protocol_mapping_01_posn;


enum uart_protocol_mapping_02_posn_enum
{
   UART_PROTOCOL_MAPPING_02_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_02_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_02_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_02_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_02_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_02_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_02_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_02_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_02_posn_enum uart_protocol_mapping_02_posn;


enum uart_protocol_mapping_03_posn_enum
{
   UART_PROTOCOL_MAPPING_03_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_03_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_03_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_03_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_03_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_03_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_03_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_03_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_03_posn_enum uart_protocol_mapping_03_posn;


enum uart_protocol_mapping_04_posn_enum
{
   UART_PROTOCOL_MAPPING_04_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_04_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_04_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_04_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_04_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_04_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_04_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_04_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_04_posn_enum uart_protocol_mapping_04_posn;


enum uart_protocol_mapping_05_posn_enum
{
   UART_PROTOCOL_MAPPING_05_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_05_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_05_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_05_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_05_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_05_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_05_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_05_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_05_posn_enum uart_protocol_mapping_05_posn;


enum uart_protocol_mapping_06_posn_enum
{
   UART_PROTOCOL_MAPPING_06_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_06_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_06_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_06_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_06_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_06_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_06_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_06_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_06_posn_enum uart_protocol_mapping_06_posn;


enum uart_protocol_mapping_07_posn_enum
{
   UART_PROTOCOL_MAPPING_07_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_07_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_07_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_07_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_07_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_07_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_07_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_07_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_07_posn_enum uart_protocol_mapping_07_posn;


enum uart_protocol_mapping_08_posn_enum
{
   UART_PROTOCOL_MAPPING_08_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_08_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_08_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_08_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_08_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_08_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_08_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_08_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_08_posn_enum uart_protocol_mapping_08_posn;


enum uart_protocol_mapping_09_posn_enum
{
   UART_PROTOCOL_MAPPING_09_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_09_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_09_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_09_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_09_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_09_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_09_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_09_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_09_posn_enum uart_protocol_mapping_09_posn;


enum uart_protocol_mapping_10_posn_enum
{
   UART_PROTOCOL_MAPPING_10_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_10_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_10_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_10_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_10_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_10_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_10_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_10_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_10_posn_enum uart_protocol_mapping_10_posn;


enum uart_protocol_mapping_11_posn_enum
{
   UART_PROTOCOL_MAPPING_11_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_11_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_11_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_11_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_11_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_11_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_11_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_11_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_11_posn_enum uart_protocol_mapping_11_posn;


enum uart_protocol_mapping_12_posn_enum
{
   UART_PROTOCOL_MAPPING_12_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_12_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_12_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_12_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_12_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_12_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_12_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_12_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_12_posn_enum uart_protocol_mapping_12_posn;


enum uart_protocol_mapping_13_posn_enum
{
   UART_PROTOCOL_MAPPING_13_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_13_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_13_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_13_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_13_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_13_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_13_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_13_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_13_posn_enum uart_protocol_mapping_13_posn;


enum uart_protocol_mapping_14_posn_enum
{
   UART_PROTOCOL_MAPPING_14_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_14_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_14_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_14_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_14_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_14_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_14_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_14_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_14_posn_enum uart_protocol_mapping_14_posn;


enum uart_protocol_mapping_15_posn_enum
{
   UART_PROTOCOL_MAPPING_15_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_15_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_15_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_15_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_15_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_15_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_15_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_15_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_15_posn_enum uart_protocol_mapping_15_posn;


enum uart_protocol_mapping_16_posn_enum
{
   UART_PROTOCOL_MAPPING_16_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_16_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_16_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_16_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_16_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_16_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_16_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_16_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_16_posn_enum uart_protocol_mapping_16_posn;


enum uart_protocol_mapping_17_posn_enum
{
   UART_PROTOCOL_MAPPING_17_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_17_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_17_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_17_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_17_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_17_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_17_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_17_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_17_posn_enum uart_protocol_mapping_17_posn;


enum uart_protocol_mapping_18_posn_enum
{
   UART_PROTOCOL_MAPPING_18_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_18_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_18_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_18_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_18_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_18_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_18_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_18_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_18_posn_enum uart_protocol_mapping_18_posn;


enum uart_protocol_mapping_19_posn_enum
{
   UART_PROTOCOL_MAPPING_19_UART_PROTOCOL_MAPPING_ID_LSB_POSN = (int)0,
   UART_PROTOCOL_MAPPING_19_UART_PROTOCOL_MAPPING_ID_MSB_POSN = (int)7,
   UART_PROTOCOL_MAPPING_19_UART_PROTOCOL_MAPPING_HCI_TYPE_LSB_POSN = (int)8,
   UART_PROTOCOL_MAPPING_19_UART_PROTOCOL_MAPPING_HCI_TYPE_MSB_POSN = (int)9,
   UART_PROTOCOL_MAPPING_19_UART_PROTOCOL_MAPPING_DESTINATION_SSID_LSB_POSN = (int)10,
   UART_PROTOCOL_MAPPING_19_UART_PROTOCOL_MAPPING_DESTINATION_SSID_MSB_POSN = (int)13,
   UART_PROTOCOL_MAPPING_19_UART_PROTOCOL_MAPPING_VALID_LSB_POSN = (int)14,
   UART_PROTOCOL_MAPPING_19_UART_PROTOCOL_MAPPING_VALID_MSB_POSN = (int)14
};
typedef enum uart_protocol_mapping_19_posn_enum uart_protocol_mapping_19_posn;


#endif /* IO_DEFS_MODULE_UART */
#endif /* __IO_DEFS_H__IO_DEFS_MODULE_UART */
...
#if defined(IO_DEFS_MODULE_BUS_INTERRUPT) 

#ifndef __IO_DEFS_H__IO_DEFS_MODULE_BUS_INTERRUPT
#define __IO_DEFS_H__IO_DEFS_MODULE_BUS_INTERRUPT
...
enum bus_interrupt__access_ctrl_enum_posn_enum
{
   BUS_INTERRUPT__P0_ACCESS_PERMISSION_POSN           = (int)0,
   BUS_INTERRUPT__ACCESS_CTRL_ENUM_BUS_INTERRUPT__P0_ACCESS_PERMISSION_LSB_POSN = (int)0,
   BUS_INTERRUPT__ACCESS_CTRL_ENUM_BUS_INTERRUPT__P0_ACCESS_PERMISSION_MSB_POSN = (int)0,
   BUS_INTERRUPT__P1_ACCESS_PERMISSION_POSN           = (int)1,
   BUS_INTERRUPT__ACCESS_CTRL_ENUM_BUS_INTERRUPT__P1_ACCESS_PERMISSION_LSB_POSN = (int)1,
   BUS_INTERRUPT__ACCESS_CTRL_ENUM_BUS_INTERRUPT__P1_ACCESS_PERMISSION_MSB_POSN = (int)1,
   BUS_INTERRUPT__P2_ACCESS_PERMISSION_POSN           = (int)2,
   BUS_INTERRUPT__ACCESS_CTRL_ENUM_BUS_INTERRUPT__P2_ACCESS_PERMISSION_LSB_POSN = (int)2,
   BUS_INTERRUPT__ACCESS_CTRL_ENUM_BUS_INTERRUPT__P2_ACCESS_PERMISSION_MSB_POSN = (int)2,
   BUS_INTERRUPT__P3_ACCESS_PERMISSION_POSN           = (int)3,
   BUS_INTERRUPT__ACCESS_CTRL_ENUM_BUS_INTERRUPT__P3_ACCESS_PERMISSION_LSB_POSN = (int)3,
   BUS_INTERRUPT__ACCESS_CTRL_ENUM_BUS_INTERRUPT__P3_ACCESS_PERMISSION_MSB_POSN = (int)3
};
typedef enum bus_interrupt__access_ctrl_enum_posn_enum bus_interrupt__access_ctrl_enum_posn;

#define BUS_INTERRUPT__P0_ACCESS_PERMISSION_MASK (0x00000001u)
#define BUS_INTERRUPT__P1_ACCESS_PERMISSION_MASK (0x00000002u)
#define BUS_INTERRUPT__P2_ACCESS_PERMISSION_MASK (0x00000004u)
#define BUS_INTERRUPT__P3_ACCESS_PERMISSION_MASK (0x00000008u)

enum bus_interrupt__p0_access_permission_enum
{
   BUS_INTERRUPT__P0_ACCESS_BLOCKED         = (int)0x0,
   BUS_INTERRUPT__P0_ACCESS_UNBLOCKED       = (int)0x1,
   MAX_BUS_INTERRUPT__P0_ACCESS_PERMISSION  = (int)0x1
};
#define NUM_BUS_INTERRUPT__P0_ACCESS_PERMISSION (0x2)
typedef enum bus_interrupt__p0_access_permission_enum bus_interrupt__p0_access_permission;


enum bus_interrupt__p1_access_permission_enum
{
   BUS_INTERRUPT__P1_ACCESS_BLOCKED         = (int)0x0,
   BUS_INTERRUPT__P1_ACCESS_UNBLOCKED       = (int)0x1,
   MAX_BUS_INTERRUPT__P1_ACCESS_PERMISSION  = (int)0x1
};
#define NUM_BUS_INTERRUPT__P1_ACCESS_PERMISSION (0x2)
typedef enum bus_interrupt__p1_access_permission_enum bus_interrupt__p1_access_permission;


enum bus_interrupt__p2_access_permission_enum
{
   BUS_INTERRUPT__P2_ACCESS_BLOCKED         = (int)0x0,
   BUS_INTERRUPT__P2_ACCESS_UNBLOCKED       = (int)0x1,
   MAX_BUS_INTERRUPT__P2_ACCESS_PERMISSION  = (int)0x1
};
#define NUM_BUS_INTERRUPT__P2_ACCESS_PERMISSION (0x2)
typedef enum bus_interrupt__p2_access_permission_enum bus_interrupt__p2_access_permission;


enum bus_interrupt__p3_access_permission_enum
{
   BUS_INTERRUPT__P3_ACCESS_BLOCKED         = (int)0x0,
   BUS_INTERRUPT__P3_ACCESS_UNBLOCKED       = (int)0x1,
   MAX_BUS_INTERRUPT__P3_ACCESS_PERMISSION  = (int)0x1
};
#define NUM_BUS_INTERRUPT__P3_ACCESS_PERMISSION (0x2)
typedef enum bus_interrupt__p3_access_permission_enum bus_interrupt__p3_access_permission;


enum bus_interrupt__mutex_lock_enum_enum
{
   BUS_INTERRUPT__MUTEX_AVAILABLE           = (int)0x0,
   BUS_INTERRUPT__MUTEX_CLAIMED_BY_P0       = (int)0x1,
   BUS_INTERRUPT__MUTEX_CLAIMED_BY_P1       = (int)0x2,
   BUS_INTERRUPT__MUTEX_CLAIMED_BY_P2       = (int)0x4,
   BUS_INTERRUPT__MUTEX_CLAIMED_BY_P3       = (int)0x8,
   BUS_INTERRUPT__MUTEX_DISABLED            = (int)0xF,
   MAX_BUS_INTERRUPT__MUTEX_LOCK_ENUM       = (int)0xF
};
typedef enum bus_interrupt__mutex_lock_enum_enum bus_interrupt__mutex_lock_enum;
...
enum bus_int_access_ctrl_posn_enum
{
   BUS_INT_ACCESS_CTRL_BUS_INTERRUPT__P0_ACCESS_PERMISSION_LSB_POSN = (int)0,
   BUS_INT_ACCESS_CTRL_BUS_INTERRUPT__P0_ACCESS_PERMISSION_MSB_POSN = (int)0,
   BUS_INT_ACCESS_CTRL_BUS_INTERRUPT__P1_ACCESS_PERMISSION_LSB_POSN = (int)1,
   BUS_INT_ACCESS_CTRL_BUS_INTERRUPT__P1_ACCESS_PERMISSION_MSB_POSN = (int)1,
   BUS_INT_ACCESS_CTRL_BUS_INTERRUPT__P2_ACCESS_PERMISSION_LSB_POSN = (int)2,
   BUS_INT_ACCESS_CTRL_BUS_INTERRUPT__P2_ACCESS_PERMISSION_MSB_POSN = (int)2,
   BUS_INT_ACCESS_CTRL_BUS_INTERRUPT__P3_ACCESS_PERMISSION_LSB_POSN = (int)3,
   BUS_INT_ACCESS_CTRL_BUS_INTERRUPT__P3_ACCESS_PERMISSION_MSB_POSN = (int)3
};
typedef enum bus_int_access_ctrl_posn_enum bus_int_access_ctrl_posn;


#endif /* IO_DEFS_MODULE_BUS_INTERRUPT */
#endif /* __IO_DEFS_H__IO_DEFS_MODULE_BUS_INTERRUPT */
...
#if defined(IO_DEFS_MODULE_UART_PER_SS) 

#ifndef __IO_DEFS_H__IO_DEFS_MODULE_UART_PER_SS
#define __IO_DEFS_H__IO_DEFS_MODULE_UART_PER_SS

/* -- uart_per_ss -- UART Registers per Subsystem: Each SS has an independent copy of these registers -- */

enum uart_event_types_posn_enum
{
   UART_EVENT_IDX_RX_SUCCESS_POSN                     = (int)0,
   UART_EVENT_TYPES_UART_EVENT_IDX_RX_SUCCESS_LSB_POSN = (int)0,
   UART_EVENT_TYPES_UART_EVENT_IDX_RX_SUCCESS_MSB_POSN = (int)0,
   UART_EVENT_IDX_TX_SUCCESS_POSN                     = (int)1,
   UART_EVENT_TYPES_UART_EVENT_IDX_TX_SUCCESS_LSB_POSN = (int)1,
   UART_EVENT_TYPES_UART_EVENT_IDX_TX_SUCCESS_MSB_POSN = (int)1,
   UART_EVENT_IDX_TX_ERROR_POSN                       = (int)2,
   UART_EVENT_TYPES_UART_EVENT_IDX_TX_ERROR_LSB_POSN  = (int)2,
   UART_EVENT_TYPES_UART_EVENT_IDX_TX_ERROR_MSB_POSN  = (int)2,
   UART_EVENT_IDX_BCSP_CHECKSUM_ERROR_POSN            = (int)3,
   UART_EVENT_TYPES_UART_EVENT_IDX_BCSP_CHECKSUM_ERROR_LSB_POSN = (int)3,
   UART_EVENT_TYPES_UART_EVENT_IDX_BCSP_CHECKSUM_ERROR_MSB_POSN = (int)3,
   UART_EVENT_IDX_BCSP_LENGTH_ERROR_POSN              = (int)4,
   UART_EVENT_TYPES_UART_EVENT_IDX_BCSP_LENGTH_ERROR_LSB_POSN = (int)4,
   UART_EVENT_TYPES_UART_EVENT_IDX_BCSP_LENGTH_ERROR_MSB_POSN = (int)4,
   UART_EVENT_IDX_BCSP_SEQ_NUM_ERROR_POSN             = (int)5,
   UART_EVENT_TYPES_UART_EVENT_IDX_BCSP_SEQ_NUM_ERROR_LSB_POSN = (int)5,
   UART_EVENT_TYPES_UART_EVENT_IDX_BCSP_SEQ_NUM_ERROR_MSB_POSN = (int)5,
   UART_EVENT_IDX_BCSP_CRC_ERROR_POSN                 = (int)6,
   UART_EVENT_TYPES_UART_EVENT_IDX_BCSP_CRC_ERROR_LSB_POSN = (int)6,
   UART_EVENT_TYPES_UART_EVENT_IDX_BCSP_CRC_ERROR_MSB_POSN = (int)6,
   UART_EVENT_IDX_RX_OVERRUN_ERROR_POSN               = (int)7,
   UART_EVENT_TYPES_UART_EVENT_IDX_RX_OVERRUN_ERROR_LSB_POSN = (int)7,
   UART_EVENT_TYPES_UART_EVENT_IDX_RX_OVERRUN_ERROR_MSB_POSN = (int)7,
   UART_EVENT_IDX_RX_PAYLOAD_BUFFER_ERROR_POSN        = (int)8,
   UART_EVENT_TYPES_UART_EVENT_IDX_RX_PAYLOAD_BUFFER_ERROR_LSB_POSN = (int)8,
   UART_EVENT_TYPES_UART_EVENT_IDX_RX_PAYLOAD_BUFFER_ERROR_MSB_POSN = (int)8,
   UART_EVENT_IDX_RX_IDLE_POSN                        = (int)9,
   UART_EVENT_TYPES_UART_EVENT_IDX_RX_IDLE_LSB_POSN   = (int)9,
   UART_EVENT_TYPES_UART_EVENT_IDX_RX_IDLE_MSB_POSN   = (int)9,
   UART_EVENT_IDX_SEQUENCE_FOUND_POSN                 = (int)10,
   UART_EVENT_TYPES_UART_EVENT_IDX_SEQUENCE_FOUND_LSB_POSN = (int)10,
   UART_EVENT_TYPES_UART_EVENT_IDX_SEQUENCE_FOUND_MSB_POSN = (int)10
};
typedef enum uart_event_types_posn_enum uart_event_types_posn;

#define UART_EVENT_IDX_RX_SUCCESS_MASK           (0x00000001u)
#define UART_EVENT_IDX_TX_SUCCESS_MASK           (0x00000002u)
#define UART_EVENT_IDX_TX_ERROR_MASK             (0x00000004u)
#define UART_EVENT_IDX_BCSP_CHECKSUM_ERROR_MASK  (0x00000008u)
#define UART_EVENT_IDX_BCSP_LENGTH_ERROR_MASK    (0x00000010u)
#define UART_EVENT_IDX_BCSP_SEQ_NUM_ERROR_MASK   (0x00000020u)
#define UART_EVENT_IDX_BCSP_CRC_ERROR_MASK       (0x00000040u)
#define UART_EVENT_IDX_RX_OVERRUN_ERROR_MASK     (0x00000080u)
#define UART_EVENT_IDX_RX_PAYLOAD_BUFFER_ERROR_MASK (0x00000100u)
#define UART_EVENT_IDX_RX_IDLE_MASK              (0x00000200u)
#define UART_EVENT_IDX_SEQUENCE_FOUND_MASK       (0x00000400u)

enum uart_tx_td_buffer0_posn_enum
{
   TX_TD_BUFFER_Q0_HANDLE_LSB_POSN                    = (int)0,
   UART_TX_TD_BUFFER0_TX_TD_BUFFER_Q0_HANDLE_LSB_POSN = (int)0,
   TX_TD_BUFFER_Q0_HANDLE_MSB_POSN                    = (int)7,
   UART_TX_TD_BUFFER0_TX_TD_BUFFER_Q0_HANDLE_MSB_POSN = (int)7,
   TX_TD_BUFFER_Q0_PRIORITY_LSB_POSN                  = (int)8,
   UART_TX_TD_BUFFER0_TX_TD_BUFFER_Q0_PRIORITY_LSB_POSN = (int)8,
   TX_TD_BUFFER_Q0_PRIORITY_MSB_POSN                  = (int)10,
   UART_TX_TD_BUFFER0_TX_TD_BUFFER_Q0_PRIORITY_MSB_POSN = (int)10
};
typedef enum uart_tx_td_buffer0_posn_enum uart_tx_td_buffer0_posn;

#define TX_TD_BUFFER_Q0_HANDLE_LSB_MASK          (0x00000001u)
#define TX_TD_BUFFER_Q0_HANDLE_MSB_MASK          (0x00000080u)
#define TX_TD_BUFFER_Q0_PRIORITY_LSB_MASK        (0x00000100u)
#define TX_TD_BUFFER_Q0_PRIORITY_MSB_MASK        (0x00000400u)

enum uart_tx_td_buffer1_posn_enum
{
   TX_TD_BUFFER_Q1_HANDLE_LSB_POSN                    = (int)0,
   UART_TX_TD_BUFFER1_TX_TD_BUFFER_Q1_HANDLE_LSB_POSN = (int)0,
   TX_TD_BUFFER_Q1_HANDLE_MSB_POSN                    = (int)7,
   UART_TX_TD_BUFFER1_TX_TD_BUFFER_Q1_HANDLE_MSB_POSN = (int)7,
   TX_TD_BUFFER_Q1_PRIORITY_LSB_POSN                  = (int)8,
   UART_TX_TD_BUFFER1_TX_TD_BUFFER_Q1_PRIORITY_LSB_POSN = (int)8,
   TX_TD_BUFFER_Q1_PRIORITY_MSB_POSN                  = (int)10,
   UART_TX_TD_BUFFER1_TX_TD_BUFFER_Q1_PRIORITY_MSB_POSN = (int)10
};
typedef enum uart_tx_td_buffer1_posn_enum uart_tx_td_buffer1_posn;

#define TX_TD_BUFFER_Q1_HANDLE_LSB_MASK          (0x00000001u)
#define TX_TD_BUFFER_Q1_HANDLE_MSB_MASK          (0x00000080u)
#define TX_TD_BUFFER_Q1_PRIORITY_LSB_MASK        (0x00000100u)
#define TX_TD_BUFFER_Q1_PRIORITY_MSB_MASK        (0x00000400u)

enum uart_rx_default_buffer_posn_enum
{
   UART_RX_DEFAULT_BUFFER_LSB_POSN                    = (int)0,
   UART_RX_DEFAULT_BUFFER_UART_RX_DEFAULT_BUFFER_LSB_POSN = (int)0,
   UART_RX_DEFAULT_BUFFER_MSB_POSN                    = (int)7,
   UART_RX_DEFAULT_BUFFER_UART_RX_DEFAULT_BUFFER_MSB_POSN = (int)7
};
typedef enum uart_rx_default_buffer_posn_enum uart_rx_default_buffer_posn;

#define UART_RX_DEFAULT_BUFFER_LSB_MASK          (0x00000001u)
#define UART_RX_DEFAULT_BUFFER_MSB_MASK          (0x00000080u)

enum uart_rx_status_buffer_posn_enum
{
   UART_RX_STATUS_BUFFER_LSB_POSN                     = (int)0,
   UART_RX_STATUS_BUFFER_UART_RX_STATUS_BUFFER_LSB_POSN = (int)0,
   UART_RX_STATUS_BUFFER_MSB_POSN                     = (int)7,
   UART_RX_STATUS_BUFFER_UART_RX_STATUS_BUFFER_MSB_POSN = (int)7
};
typedef enum uart_rx_status_buffer_posn_enum uart_rx_status_buffer_posn;

#define UART_RX_STATUS_BUFFER_LSB_MASK           (0x00000001u)
#define UART_RX_STATUS_BUFFER_MSB_MASK           (0x00000080u)

enum uart_sru_ssid_read_posn_enum
{
   UART_SRU_SSID_READ_LSB_POSN                        = (int)0,
   UART_SRU_SSID_READ_UART_SRU_SSID_READ_LSB_POSN     = (int)0,
   UART_SRU_SSID_READ_MSB_POSN                        = (int)3,
   UART_SRU_SSID_READ_UART_SRU_SSID_READ_MSB_POSN     = (int)3
};
typedef enum uart_sru_ssid_read_posn_enum uart_sru_ssid_read_posn;

#define UART_SRU_SSID_READ_LSB_MASK              (0x00000001u)
#define UART_SRU_SSID_READ_MSB_MASK              (0x00000008u)

enum uart_tx_pending_tds_q0_posn_enum
{
   UART_TX_PENDING_TDS_Q0_LSB_POSN                    = (int)0,
   UART_TX_PENDING_TDS_Q0_UART_TX_PENDING_TDS_Q0_LSB_POSN = (int)0,
   UART_TX_PENDING_TDS_Q0_MSB_POSN                    = (int)4,
   UART_TX_PENDING_TDS_Q0_UART_TX_PENDING_TDS_Q0_MSB_POSN = (int)4
};
typedef enum uart_tx_pending_tds_q0_posn_enum uart_tx_pending_tds_q0_posn;

#define UART_TX_PENDING_TDS_Q0_LSB_MASK          (0x00000001u)
#define UART_TX_PENDING_TDS_Q0_MSB_MASK          (0x00000010u)

enum uart_tx_pending_tds_q1_posn_enum
{
   UART_TX_PENDING_TDS_Q1_LSB_POSN                    = (int)0,
   UART_TX_PENDING_TDS_Q1_UART_TX_PENDING_TDS_Q1_LSB_POSN = (int)0,
   UART_TX_PENDING_TDS_Q1_MSB_POSN                    = (int)4,
   UART_TX_PENDING_TDS_Q1_UART_TX_PENDING_TDS_Q1_MSB_POSN = (int)4
};
typedef enum uart_tx_pending_tds_q1_posn_enum uart_tx_pending_tds_q1_posn;

#define UART_TX_PENDING_TDS_Q1_LSB_MASK          (0x00000001u)
#define UART_TX_PENDING_TDS_Q1_MSB_MASK          (0x00000010u)

enum uart_tx_status_buffer_posn_enum
{
   UART_TX_STATUS_BUFFER_LSB_POSN                     = (int)0,
   UART_TX_STATUS_BUFFER_UART_TX_STATUS_BUFFER_LSB_POSN = (int)0,
   UART_TX_STATUS_BUFFER_MSB_POSN                     = (int)7,
   UART_TX_STATUS_BUFFER_UART_TX_STATUS_BUFFER_MSB_POSN = (int)7
};
typedef enum uart_tx_status_buffer_posn_enum uart_tx_status_buffer_posn;

#define UART_TX_STATUS_BUFFER_LSB_MASK           (0x00000001u)
#define UART_TX_STATUS_BUFFER_MSB_MASK           (0x00000080u)

enum uart_event_desc_enable_posn_enum
{
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_RX_SUCCESS_LSB_POSN = (int)0,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_RX_SUCCESS_MSB_POSN = (int)0,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_TX_SUCCESS_LSB_POSN = (int)1,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_TX_SUCCESS_MSB_POSN = (int)1,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_TX_ERROR_LSB_POSN = (int)2,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_TX_ERROR_MSB_POSN = (int)2,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_BCSP_CHECKSUM_ERROR_LSB_POSN = (int)3,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_BCSP_CHECKSUM_ERROR_MSB_POSN = (int)3,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_BCSP_LENGTH_ERROR_LSB_POSN = (int)4,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_BCSP_LENGTH_ERROR_MSB_POSN = (int)4,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_BCSP_SEQ_NUM_ERROR_LSB_POSN = (int)5,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_BCSP_SEQ_NUM_ERROR_MSB_POSN = (int)5,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_BCSP_CRC_ERROR_LSB_POSN = (int)6,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_BCSP_CRC_ERROR_MSB_POSN = (int)6,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_RX_OVERRUN_ERROR_LSB_POSN = (int)7,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_RX_OVERRUN_ERROR_MSB_POSN = (int)7,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_RX_PAYLOAD_BUFFER_ERROR_LSB_POSN = (int)8,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_RX_PAYLOAD_BUFFER_ERROR_MSB_POSN = (int)8,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_RX_IDLE_LSB_POSN = (int)9,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_RX_IDLE_MSB_POSN = (int)9,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_SEQUENCE_FOUND_LSB_POSN = (int)10,
   UART_EVENT_DESC_ENABLE_UART_EVENT_IDX_SEQUENCE_FOUND_MSB_POSN = (int)10
};
typedef enum uart_event_desc_enable_posn_enum uart_event_desc_enable_posn;


enum uart_interrupt_enable_posn_enum
{
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_RX_SUCCESS_LSB_POSN = (int)0,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_RX_SUCCESS_MSB_POSN = (int)0,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_TX_SUCCESS_LSB_POSN = (int)1,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_TX_SUCCESS_MSB_POSN = (int)1,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_TX_ERROR_LSB_POSN = (int)2,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_TX_ERROR_MSB_POSN = (int)2,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_BCSP_CHECKSUM_ERROR_LSB_POSN = (int)3,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_BCSP_CHECKSUM_ERROR_MSB_POSN = (int)3,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_BCSP_LENGTH_ERROR_LSB_POSN = (int)4,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_BCSP_LENGTH_ERROR_MSB_POSN = (int)4,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_BCSP_SEQ_NUM_ERROR_LSB_POSN = (int)5,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_BCSP_SEQ_NUM_ERROR_MSB_POSN = (int)5,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_BCSP_CRC_ERROR_LSB_POSN = (int)6,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_BCSP_CRC_ERROR_MSB_POSN = (int)6,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_RX_OVERRUN_ERROR_LSB_POSN = (int)7,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_RX_OVERRUN_ERROR_MSB_POSN = (int)7,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_RX_PAYLOAD_BUFFER_ERROR_LSB_POSN = (int)8,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_RX_PAYLOAD_BUFFER_ERROR_MSB_POSN = (int)8,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_RX_IDLE_LSB_POSN = (int)9,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_RX_IDLE_MSB_POSN = (int)9,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_SEQUENCE_FOUND_LSB_POSN = (int)10,
   UART_INTERRUPT_ENABLE_UART_EVENT_IDX_SEQUENCE_FOUND_MSB_POSN = (int)10
};
typedef enum uart_interrupt_enable_posn_enum uart_interrupt_enable_posn;


#endif /* IO_DEFS_MODULE_UART_PER_SS */
#endif /* __IO_DEFS_H__IO_DEFS_MODULE_UART_PER_SS */
