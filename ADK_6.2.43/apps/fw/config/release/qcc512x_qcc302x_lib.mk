...
#   %%version
# Top level makefile fragment for the aura P1 firmware library build (d01
...
PROJECT=qcc512x_qcc302x

CORE_MODULES_LIST =../config/core/firmware_modules_p1.mk
CUSTOMER_MODULES_LIST =../config/customer/firmware_modules_aura_lib.mk
...
include ../config/lib_firmware.mk
