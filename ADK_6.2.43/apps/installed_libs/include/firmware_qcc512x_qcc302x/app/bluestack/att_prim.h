...
/*!
    \brief The Indication/Notification data is in an MBLK.
*/
#define ATT_HANDLE_VALUE_MBLK           0x0002

/*!
    \brief The Indication/Notification is from a stream.
*/
#define ATT_HANDLE_VALUE_STREAM         0x0004
