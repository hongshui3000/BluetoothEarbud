...
{
    return sizeof(standard_set_param_msg_t) + sizeof(standard_param_data_block_t) * number_of_params;
}
...
{
    return sizeof(standard_get_param_msg_t) + sizeof(standard_param_request_block_t) * number_of_params;
}
...
{
    return sizeof(standard_get_param_response_msg_t) + sizeof(standard_param_data_block_t) * number_of_params;
}
