...
/* Handsfree variants */
const CvcPluginTaskdata csr_cvsd_cvc_1mic_handsfree_plugin = {{AudioVoiceHfpMessageHandler},cvc_1_mic_handsfree_cvsd, link_encoding_cvsd, 0, 0, BITFIELD_CAST(6, 0)};
const CvcPluginTaskdata csr_wbs_cvc_1mic_handsfree_plugin = {{AudioVoiceHfpMessageHandler},cvc_1_mic_handsfree_msbc, link_encoding_msbc, 0, 1, BITFIELD_CAST(6, 0)};

const CvcPluginTaskdata csr_cvsd_cvc_2mic_handsfree_plugin = {{AudioVoiceHfpMessageHandler},cvc_2_mic_handsfree_cvsd, link_encoding_cvsd, 1, 0, BITFIELD_CAST(6, 0)};
const CvcPluginTaskdata csr_wbs_cvc_2mic_handsfree_plugin = {{AudioVoiceHfpMessageHandler},cvc_2_mic_handsfree_msbc, link_encoding_msbc, 1, 1, BITFIELD_CAST(6, 0)};
...
/*ASR variants*/
const CvcPluginTaskdata csr_cvsd_cvc_1mic_asr_plugin = {{AudioVoiceHfpMessageHandler},cvc_1_mic_headset_cvsd_asr, link_encoding_cvsd, 0, 0, BITFIELD_CAST(6, 0)};
const CvcPluginTaskdata csr_cvsd_cvc_2mic_asr_plugin = {{AudioVoiceHfpMessageHandler},cvc_2_mic_headset_cvsd_asr, link_encoding_cvsd, 1, 0, BITFIELD_CAST(6, 0)};

const CvcPluginTaskdata csr_cvsd_cvc_1mic_hf_asr_plugin = {{AudioVoiceHfpMessageHandler},cvc_1_mic_handsfree_cvsd_asr, link_encoding_cvsd, 0, 0, BITFIELD_CAST(6, 0)};
const CvcPluginTaskdata csr_cvsd_cvc_2mic_hf_asr_plugin = {{AudioVoiceHfpMessageHandler},cvc_2_mic_handsfree_cvsd_asr, link_encoding_cvsd, 1, 0, BITFIELD_CAST(6, 0)};
