...
static void connectionBluestackHandlerDm(connectionState *theCm, const DM_UPRIM_T *message)
{
    ...
    if (state == connectionReady)
    {
        ...
        switch (message->type)
        {
            ...
            {
                PRINT(("DM_CRYPTO_GENERATE_PUBLIC_PRIVATE_KEY_CFM\n"));
            ...
            {
                PRINT(("DM_CRYPTO_GENERATE_SHARED_SECRET_KEY_CFM\n"));
            ...
            case DM_ULP_ENABLE_ZERO_SLAVE_LATENCY_CFM:
                PRINT(("DM_ULP_ENABLE_ZERO_SLAVE_LATENCY_CFM\n"));
            ...
            case DM_HCI_ULP_CHANNEL_SELECTION_ALGORITHM_IND :
                PRINT(("DM_HCI_ULP_CHANNEL_SELECTION_ALGORITHM_IND\n"));
