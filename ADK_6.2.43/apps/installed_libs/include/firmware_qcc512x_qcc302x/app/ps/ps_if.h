...
/** This offset needs to be added to a key id to write the key with PsStore.
 * The keys can be than read as usual with PsFullRetrieve().
 * This is a temporary hack to help with application debugging. */
#define PSKEY_FULL_STORE_OFFSET 0x1000
