...
/*******************************************************************************
 ...
 VALUES
    MUTE_MIC_OUTPUT        - mutes/unmutes microphone output of AEC Reference
    ENABLE_SPKR_INPUT_GATE - Enables AEC reference to have a TTP based gate at
                             ...
                             NOTE: This message is no longer supported/required,
                             AEC Reference capability now supports full TTP
                             playback in speaker path.
...
/*******************************************************************************
  ...
  NAME
    OPMSG_RATE_ADJUST_ID

  DESCRIPTION
    Standalone Rate Adjustment operator configuration messages

 VALUES
    SET_SAMPLE_RATE      - Sets sample rate Format: rate in 25Hz units
    SET_TARGET_RATE_ADDR - Private message to set the address of target rate
    SET_PASSTHROUG_MODE  - Private message to set the passthrough mode of the
                           operator
    SET_CURRENT_RATE     - Private message to ets current warp rate for the
                           operator

*******************************************************************************/
typedef enum
{
    OPMSG_RATE_ADJUST_ID_SET_SAMPLE_RATE = 0x0001,
    OPMSG_RATE_ADJUST_ID_SET_TARGET_RATE_ADDR = 0x00FC,
    OPMSG_RATE_ADJUST_ID_SET_PASSTHROUG_MODE = 0x00FD,
    OPMSG_RATE_ADJUST_ID_SET_CURRENT_RATE = 0x00FE
} OPMSG_RATE_ADJUST_ID;
/*******************************************************************************
...
/*******************************************************************************
 ...
 VALUES
    ...
    SET_DATA_FORMAT - Sets the expected input and output terminal data formats
