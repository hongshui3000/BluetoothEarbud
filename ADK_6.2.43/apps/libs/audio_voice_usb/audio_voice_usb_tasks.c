...
/* Handsfree variants */
const CvcPluginTaskdata usb_nb_cvc_1mic_handsfree_plugin = {{AudioVoiceUsbMessageHandler}, cvc_1_mic_handsfree_cvsd, link_encoding_cvsd, 0, 0, BITFIELD_CAST(6, 0)};
const CvcPluginTaskdata usb_wb_cvc_1mic_handsfree_plugin = {{AudioVoiceUsbMessageHandler}, cvc_1_mic_handsfree_msbc, link_encoding_msbc, 0, 1, BITFIELD_CAST(6, 0)};

const CvcPluginTaskdata usb_nb_cvc_2mic_handsfree_plugin = {{AudioVoiceUsbMessageHandler}, cvc_2_mic_handsfree_cvsd, link_encoding_cvsd, 1, 0, BITFIELD_CAST(6, 0)};
const CvcPluginTaskdata usb_wb_cvc_2mic_handsfree_plugin = {{AudioVoiceUsbMessageHandler}, cvc_2_mic_handsfree_msbc, link_encoding_msbc, 1, 1, BITFIELD_CAST(6, 0)};
