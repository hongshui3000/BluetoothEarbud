...
/**
 * \file
 * Header for VM library module that implements
 * USB Audio 1.0 class device support
 */
...
/*! Helpers */
#define REQ_CS(req)         (uint8)(req.wValue >> 8)
#define REQ_CN(req)         (req.wValue & 0xFF)
#define REQ_CODE(req)       (req.bRequest & 0x07)
#define REQ_UNIT(req)       (uint8)(req.wIndex >> 8)
...
#define VOL_SETTING(x) (int16)((x/3)+15)
