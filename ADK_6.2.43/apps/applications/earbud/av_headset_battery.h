...
enum battery_messages
{
    ...
    MESSAGE_BATTERY_LEVEL_UPDATE_VOLTAGE = EB_BATTERY_MESSAGE_BASE,
...
typedef struct
{
    ...
    enum battery_level_state state;
...
extern enum battery_level_state appBatteryGetState(void);
