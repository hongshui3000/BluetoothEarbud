...
class comp_defines:
    ...
    def __init__(self, filename):
        ...
        if not exists(filename):
            print "The definition file", filename, "does not exist!  EXITING..."
            sys.exit()
    ...
    def append(self, name, val = 1):
        ...
        if self.defs.has_key(name):
            print "Define already exists. Key", name, "not added to defines list" 
            return
        self.defs[name] = val
    ...
    def edit(self, name, val):
        ...
        if self.defs.has_key(name):
            ...
            print "The define", name, "does not exist and has not been edited"
