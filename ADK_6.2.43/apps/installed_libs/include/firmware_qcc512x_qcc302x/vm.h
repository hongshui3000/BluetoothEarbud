 ...
 *  profiles.
 *             For example, on \Stretto, \c VM_PERFORMANCE profile will configure
 *  the application CPU and the 
 *             flash interface to 80 MHz offering additional code and flash
 *  performance.
 *             Profile changes can be requested by the application at runtime
 *  during execution. However profile changes 
