...
/**
 * \defgroup ipc_init IPC initialisation
 * \ingroup ipc
 */
...
/**
 * \defgroup ipc_send IPC send API
 * \ingroup ipc
 */
...
/**
 * Helper macro for getting the pull resistors satus of several PIOs.
 * @param req Pointer to request message indicating which PIOs to get.
...
/**
 * Helper funciton to make it convenient to send Bluestack primitives
...
/**
 * \defgroup ipc_recv IPC receive API
 * \ingroup ipc
 */
