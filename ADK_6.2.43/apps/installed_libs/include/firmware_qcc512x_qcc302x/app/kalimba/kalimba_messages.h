...
/*
  ...
  Arguments
    ...
    word 3 - bits 15:0 of BDADDR
*/
#define KAL_MSG_GET_WALL_CLOCK_TBTA  0x801B
...
*/
#define KAL_LONG_MSG_WALL_CLOCK_RESPONSE_TBTA  0x801C
...
/*
  ...
  Arguments
    ...
    word 3 - bits 15:0 of BDADDR
*/
#define KAL_MSG_WALL_CLOCK_FAILED_TBTA  0x801D
...
/*
  ...
  Arguments
    ...
    word 3 - bits 15:0 of BDADDR
*/
#define KAL_MSG_GET_NEXT_ACTIVITY_TIME  0x801E
...
/*
  ...
  Arguments
    ...
    word 5 - LS 16bits of clock
*/
#define KAL_LONG_MSG_GET_NEXT_ACTIVITY_TIME_RESPONSE  0x801F
...
/*
  ...
  Arguments
    ...
    word 3 - bits 15:0 of BDADDR
*/
#define KAL_MSG_GET_NEXT_ACTIVITY_TIME_FAILED  0x8020
...
*/
#define KAL_MSG_CHANGE_PIO_OWNERSHIP  0x8021
...
*/
#define KAL_MSG_PIO_OWNERSHIP_RESPONSE  0x8022

/* Not documented yet; WIP; Reserve ID on mainline */
#define KAL_MSG_CONFIGURE_BITSERIALISER  0x8023
...
*/
#define KAL_MSG_CHARGER_LIMIT_CURRENT_USE 0x8024


/* Not documented yet: WIP; Reserve ID on mainline */
#define KAL_MSG_CONFIGURE_QPWM              0x8025

/* Not documented on mainline. Vultan specific message */
#define KAL_MSG_CONFIGURE_XIO                0x8026
...
*/
#define KAL_MSG_REGISTER_COPIES_REQUEST      0x8027
...
/*
   ...
   Arguments
     ...
     :
*/
#define KAL_MSG_REGISTER_COPIES_REPLY      0x8028
...
*/
#define KAL_MSG_REGISTER_COPIES_ALERT      0x8029
...
*/
#define KAL_MSG_BITSERIAL_BUS_SWITCH         0x802A
...
*/
#define KAL_MSG_AUDIO_STREAM_RATE_EVENT     0x802B
...
*/
#define KAL_MSG_SPDIF_CHNL_STS_EVENT     0x802C
...
*/
#define KAL_MSG_AUDIO_CONFIGURE     0x802D
...
/*
  ...
  Arguments
    ...
    word 1 - non-zero for success, zero for failure
*/
#define KAL_MSG_AUDIO_CONFIGURE_RESPONSE 0x802E
...
*/
#define KAL_MSG_ACTIVATE_AUDIO     0x802F
...
/*
  ...
  Arguments
    ...
    word 1 - non-zero for success, zero for failure
*/
#define KAL_MSG_ACTIVATE_AUDIO_RESPONSE 0x8030
...
/*
  ...
  Arguments
    ...
    word 1 : n - port list
*/
#define KAL_MSG_SPDIF_BLOCK_START_EVENT     0x8031
...
*/
#define KAL_MSG_OTP_READ_DATA 0x8032
...
*/
#define KAL_MSG_OTP_READ_DATA_RESPONSE     0x8033
...
*/
#define KAL_MSG_AUDIO_INFO_REQ  0x8034
...
*/
#define KAL_MSG_AUDIO_INFO_RESP 0x8035

/*
  Request from DSP to close the specified file

  DSP->FW

  Asks the firmware to close the specified file

  Arguments
    index      the index of the file to be closed
*/
#define KAL_MSG_CLOSE_FILE_INDEX     0x8036
...
#define KAL_MSG_IMMEDIATE_PANIC  0xFFC0
