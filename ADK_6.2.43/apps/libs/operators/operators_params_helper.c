...
{
    unsigned memory_size = sizeof(set_params_data_t) + number_of_params * sizeof(standard_param_t);
...
{
    unsigned memory_size = sizeof(get_params_data_t) + number_of_params * sizeof(standard_param_t);
