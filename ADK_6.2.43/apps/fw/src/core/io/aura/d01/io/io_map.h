...
/* *************************************************************************  *
   ...
   $Id: //depot/bg/Releases/ADK/ADK6.2/hydra_os_aura/fw/src/core/io/aura/d01/io/io_map.h#1 $
   $Name$
   $Source$
...
#ifndef __IO_MAP_H__IO_MAP_MODULE_UART
#define __IO_MAP_H__IO_MAP_MODULE_UART
...
extern volatile uint32  UART_BCSP_RX_LAST_SEQ_NUM_WRITE;     /* RW   7 bits */
extern volatile uint32  UART_BCSP_RX_PROT_ID_READ_SELECT;    /* RW   4 bits */
extern volatile uint32  UART_BCSP_RX_SEQ_MODE_IS_PER_PROT_ID;  /* RW   1 bits */
extern volatile uint32  UART_COMMON_REGS_SS_WRITE_ENABLE;    /* RW  16 bits */
extern volatile uint32  UART_CONFIG;                         /* RW  10 bits */
extern volatile uint32  UART_CURATOR_REG_ACCESS_CONTROL;     /* RW   5 bits */
extern volatile uint32  UART_CURATOR_SSID;                   /* RW   4 bits */
extern volatile uint32  UART_DEBUG_SELECT;                   /* RW   5 bits */
extern volatile uint32  UART_EVENT_REPORTING_ERROR_STATUS_CLEAR;  /* RW   1 bits */
extern volatile uint32  UART_EVENT_REPORTING_SOFT_RESET;     /* RW   1 bits */
extern volatile uint32  UART_EVT_DESC_CC_CURATOR_ENABLE;     /* RW  16 bits */
extern volatile uint32  UART_EVT_DESC_CC_CURATOR_EVT_ENABLE;  /* RW  11 bits */
extern volatile uint32  UART_INTERRUPT_CC_CURATOR_ENABLE;    /* RW  16 bits */
extern volatile uint32  UART_INTERRUPT_CC_CURATOR_EVT_ENABLE;  /* RW  11 bits */
extern volatile uint32  UART_NO_ACTIVITY_DETECTOR;           /* RW  16 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_00;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_01;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_02;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_03;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_04;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_05;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_06;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_07;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_08;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_09;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_10;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_11;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_12;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_13;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_14;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_15;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_16;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_17;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_18;            /* RW  15 bits */
extern volatile uint32  UART_PROTOCOL_MAPPING_19;            /* RW  15 bits */
extern volatile uart_rate  UART_RATE;                           /* RW  16 bits */
extern volatile uint32  UART_RST_DELAY;                      /* RW  10 bits */
extern volatile uint32  UART_RST_EN;                         /* RW   1 bits */
extern volatile uint32  UART_RX_DEFAULT_SSID;                /* RW   4 bits */
extern volatile uint32  UART_RX_ENABLE;                      /* RW   1 bits */
extern volatile uint32  UART_RX_FORCE_END_OF_PACKET;         /* W    1 bits */
extern volatile uint32  UART_RX_IDLE_TIMEOUT;                /* RW  10 bits */
extern volatile uint32  UART_RX_PACKET_TIMEOUT;              /* RW  16 bits */
extern volatile uart_rx_protocol  UART_RX_PROTOCOL;                    /* RW   2 bits */
extern volatile uint32  UART_RX_PROTOCOL_NONE_TRANSFER_LENGTH;  /* RW  16 bits */
extern volatile uint32  UART_RX_SOFT_RESET;                  /* RW   1 bits */
extern volatile uint32  UART_SEARCH_SEQUENCE_0;              /* RW   8 bits */
extern volatile uint32  UART_SEARCH_SEQUENCE_1;              /* RW   8 bits */
extern volatile uint32  UART_SEARCH_SEQUENCE_2;              /* RW   8 bits */
extern volatile uint32  UART_SEARCH_SEQUENCE_3;              /* RW   8 bits */
extern volatile uint32  UART_SEARCH_SEQUENCE_LENGTH;         /* RW   3 bits */
extern volatile uint32  UART_SRU_CONTROL;                    /* RW   8 bits */
extern volatile uint32  UART_TX_ENABLE;                      /* RW   1 bits */
extern volatile uint32  UART_TX_SOFT_RESET;                  /* RW   1 bits */
extern volatile uint32  UART_TX_TDQ0_DISABLE;                /* RW  16 bits */
extern volatile uint32  UART_TX_TDQ1_DISABLE;                /* RW  16 bits */
extern volatile uint32  UART_TX_TD_CTRL;                     /* RW   4 bits */
extern volatile uint32  UART_TX_TD_GLOBAL_CTRL;              /* RW   2 bits */

/* Declarations of read only registers */
extern volatile uint32  UART_BCSP_RX_LAST_SEQ_NUM_READ;      /* R    7 bits */
extern volatile uint32  UART_DEBUG_STATUS;                   /* R   16 bits */
extern volatile uint32  UART_EVENT_REPORTING_ERROR_STATUS;   /* R   13 bits */
extern volatile uint32  UART_NO_ACTIVITY_COUNTDOWN;          /* R   16 bits */
extern volatile uint32  UART_NUM_SUBSYS_SUPPORTED;           /* R    5 bits */
extern volatile uint32  UART_STATUS;                         /* R    5 bits */

#endif /* __IO_MAP_H__IO_MAP_MODULE_UART */
#endif /* !defined(IO_DEFS_LIMIT_MODULES) || defined(IO_DEFS_MODULE_UART) */
...
#ifndef __IO_MAP_H__IO_MAP_MODULE_BUS_INTERRUPT
#define __IO_MAP_H__IO_MAP_MODULE_BUS_INTERRUPT

/* -- bus_interrupt -- Interrupt transaction processing config and status registers -- */

/* Declarations of read/write/mixed registers */
extern volatile uint32  BUS_INT_ACCESS_CTRL;                 /* RW   4 bits */
extern volatile uint32  BUS_INT_CLEAR;                       /* RW  16 bits */
extern volatile uint32  BUS_INT_CONFIG;                      /* RW  10 bits */
extern volatile uint32  BUS_INT_MASK;                        /* RW  16 bits */
extern volatile bus_interrupt__mutex_lock_enum  BUS_INT_MUTEX_LOCK;                  /* RW   4 bits */
extern volatile uint32  BUS_INT_SELECT;                      /* RW   4 bits */
extern volatile uint32  BUS_INT_SEND_INT_CONFIG;             /* RW  12 bits */
extern volatile uint32  BUS_INT_SEND_INT_STATUS_FIELD;       /* RW  16 bits */

/* Declarations of read only registers */
extern volatile uint32  BUS_INT_CONFIG_STATUS;               /* R   10 bits */
extern volatile uint32  BUS_INT_MASK_STATUS;                 /* R   16 bits */
extern volatile uint32  BUS_INT_SEND_INT_SEND_STATUS;        /* R    2 bits */
extern volatile uint32  BUS_INT_STATUS;                      /* R   16 bits */

#endif /* __IO_MAP_H__IO_MAP_MODULE_BUS_INTERRUPT */
#endif /* !defined(IO_DEFS_LIMIT_MODULES) || defined(IO_DEFS_MODULE_BUS_INTERRUPT) */
...
#ifndef __IO_MAP_H__IO_MAP_MODULE_UART_PER_SS
#define __IO_MAP_H__IO_MAP_MODULE_UART_PER_SS

/* -- uart_per_ss -- UART Registers per Subsystem: Each SS has an independent copy of these registers -- */

/* Declarations of read/write/mixed registers */
extern volatile uint32  UART_EVENT_DESC_ENABLE;              /* RW  11 bits */
extern volatile uint32  UART_INTERRUPT_ENABLE;               /* RW  11 bits */
extern volatile uint32  UART_RX_DEFAULT_BUFFER;              /* RW   8 bits */
extern volatile uint32  UART_RX_STATUS_BUFFER;               /* RW   8 bits */
extern volatile uint32  UART_TX_STATUS_BUFFER;               /* RW   8 bits */
extern volatile uint32  UART_TX_TD_BUFFER0;                  /* RW  11 bits */
extern volatile uint32  UART_TX_TD_BUFFER1;                  /* RW  11 bits */

/* Declarations of read only registers */
extern volatile uint32  UART_SRU_SSID_READ;                  /* R    4 bits */
extern volatile uint32  UART_TX_PENDING_TDS_Q0;              /* R    5 bits */
extern volatile uint32  UART_TX_PENDING_TDS_Q1;              /* R    5 bits */

#endif /* __IO_MAP_H__IO_MAP_MODULE_UART_PER_SS */
#endif /* !defined(IO_DEFS_LIMIT_MODULES) || defined(IO_DEFS_MODULE_UART_PER_SS) */
...
extern volatile uint32  SUB_SYS_DEBUGGER_REF_ID;                /* R   16 bits */
