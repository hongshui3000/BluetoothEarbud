...
#include "gen/xap/system_keys_prim.h"
...
/*******************************************************************************
 ...
 VALUES
    ...
    STREAM_SPDIF_OUTPUT_CLK_SOURCE
                   - Set whether to MCLK clock for clocking S/PDIF output By
                     default chip syetem clock is used for s/pdif TX, using this
                     config key user can specify to use MCLK instead. Note that
                     MCLK can be from internal MPLL or an external source
                     MCLK_IN.
    ...
    STREAM_AUDIO_SAMPLE_SIZE
                   - Set Audio Sample Size. Valid values for PCM/I2S interface :
                     ...
                     16 (16 bit), 24 (24 bit).
    STREAM_AUDIO_RATE_MATCH_PARAMETER
                   - Set rate measurement/adjustment parameters for an endpoint.
                     The most significant byte of the 32-bit value is a
                     parameter ID, see Accmd_rate_match_parameter. The lower
                     three bytes are the parameter value. Not every parameter is
                     supported by each type of endpoint. Consult the endpoint
                     type documentation.
...
typedef enum
{
    ...
    ACCMD_CONFIG_KEY_STREAM_AUDIO_RATE_MATCH_PARAMETER = 0x0702,
...
/*******************************************************************************
  ...
  DESCRIPTION
    Defines the Debug Enables bitfield This enum defines the meaning of bits
    in the 'enables' bitfield used in Accmd_Set_Debug_Enables_Req.

 VALUES
    OPMGR_DEBUG_ENABLE
                   -
    OPMGR_DEBUG_MEASURE_PROC_TIME_ENABLE
                   -
    INTERRUPT_TIME_DEBUG_ENABLE
                   -
    WBS_DEC_DEBUG_ENABLE
                   -
    STREAM_DECODE_DEBUG_ENABLE
                   -
    OPMGR_PIO_DEBUG_ENABLE
                   -
    STREAM_DECODE_RM_DEBUG_ENABLE
                   -

*******************************************************************************/
typedef enum
{
    ACCMD_DEBUG_ENABLES_OPMGR_DEBUG_ENABLE = 0x0000,
    ACCMD_DEBUG_ENABLES_OPMGR_DEBUG_MEASURE_PROC_TIME_ENABLE = 0x0001,
    ACCMD_DEBUG_ENABLES_INTERRUPT_TIME_DEBUG_ENABLE = 0x0002,
    ACCMD_DEBUG_ENABLES_WBS_DEC_DEBUG_ENABLE = 0x0003,
    ACCMD_DEBUG_ENABLES_STREAM_DECODE_DEBUG_ENABLE = 0x0004,
    ACCMD_DEBUG_ENABLES_OPMGR_PIO_DEBUG_ENABLE = 0x0005,
    ACCMD_DEBUG_ENABLES_STREAM_DECODE_RM_DEBUG_ENABLE = 0x0006
} ACCMD_DEBUG_ENABLES;
/*******************************************************************************
  ...
  DESCRIPTION
    Defines for debug messages from chip
...
typedef enum
{
    ACCMD_DEBUG_ID_PCM_STARTUP_MESSAGE = 0x0001,
    ACCMD_DEBUG_ID_OPMGR_DEBUG_MESSAGE = 0x0002
} ACCMD_DEBUG_ID;
/*******************************************************************************

  NAME
    Accmd_Debug_Signal_Id

  DESCRIPTION

 VALUES
    OPMGR_DEBUG                   -
    OPMGR_DEBUG_MEASURE_PROC_TIME -
    OPMGR_PIO_DEBUG               -

*******************************************************************************/
typedef enum
{
    ACCMD_DEBUG_SIGNAL_ID_OPMGR_DEBUG = 0x0000,
    ACCMD_DEBUG_SIGNAL_ID_OPMGR_DEBUG_MEASURE_PROC_TIME = 0x0001,
    ACCMD_DEBUG_SIGNAL_ID_OPMGR_PIO_DEBUG = 0x0005
} ACCMD_DEBUG_SIGNAL_ID;
/*******************************************************************************
 ...
 VALUES
    ...
    AUDIO_LOCALLY_CLOCKED   - Request whether the audio hardware is locally or
                              remotely clocked
    AUDIO_INSTANCE          - Request the hardware instance of an audio
                              sink/source
    AUDIO_CHANNEL           - Request the hardware channel of an audio
                              sink/source
    AUDIO_SAMPLE_FORMAT     - Request the Audio Sample format, i.e. 8,13,16 or
                              24 bit
    AUDIO_CLOCK_SOURCE_TYPE - Request the clock source type
    MASTER_CLOCK_RATE       - the MCLK clock rate that is required by the
                              endpoint, in Hz. Only S/PDIF Tx and I2S/PCM master
                              can use MCLK.
    AUDIO_HW_RM_AVAILABLE   - Request whether the audio hardware supports warp
    ENDPOINT_EXISTS         - Requests whether the given sid corresponds to an
                              endpoint that currently exists. Returns success if
                              it does, failure if it doesn't. Returned value is
...
/*******************************************************************************
  ...
  NAME
    Accmd_Opmgr_Debug_Measure_Proc_Time_Config_Type

  DESCRIPTION
    Select either opmgr config or logging enabling/disabling
...
typedef enum
{
    ACCMD_OPMGR_DEBUG_MEASURE_PROC_TIME_CONFIG_TYPE_OP_LOG_ENABLE = 0x0001
} ACCMD_OPMGR_DEBUG_MEASURE_PROC_TIME_CONFIG_TYPE;
/*******************************************************************************

  NAME
    Accmd_Opmgr_Pio_Debug_Config_Type

  DESCRIPTION
    Select either pio number or pattern
...
typedef enum
{
    ACCMD_OPMGR_PIO_DEBUG_CONFIG_TYPE_NUMBER = 0x0000,
    ACCMD_OPMGR_PIO_DEBUG_CONFIG_TYPE_PATTERN = 0x0001
} ACCMD_OPMGR_PIO_DEBUG_CONFIG_TYPE;
/*******************************************************************************

  NAME
    Accmd_Opmgr_Pio_Debug_Pattern_Type

  DESCRIPTION
    matches Accmd_Opmgr_Pio_Debug_Config_Message_Config when Config_Type is
    PATTERN currently unused here, but is used in opmgr
...
typedef enum
{
    ACCMD_OPMGR_PIO_DEBUG_PATTERN_TYPE_SEPARATE = 0x0000,
    ACCMD_OPMGR_PIO_DEBUG_PATTERN_TYPE_TOTAL = 0x0001
} ACCMD_OPMGR_PIO_DEBUG_PATTERN_TYPE;
/*******************************************************************************
...
/*******************************************************************************
  ...
  DESCRIPTION
    Request messages Response messages Test Request messages Test response
    messages
 ...
 VALUES
    ...
    SET_ANC_IIR_FILTER_RESP          -
    SET_ANC_LPF_FILTER_RESP          -
    STREAM_ANC_ENABLE_RESP           -
    STREAM_SIDETONE_EN_RESP          -
...
typedef enum
{
    ...
    ACCMD_SIGNAL_ID_SET_ANC_IIR_FILTER_RESP = 0x4036,
    ACCMD_SIGNAL_ID_SET_ANC_LPF_FILTER_RESP = 0x4037,
    ACCMD_SIGNAL_ID_STREAM_ANC_ENABLE_RESP = 0x4038,
    ACCMD_SIGNAL_ID_STREAM_SIDETONE_EN_RESP = 0x4039,
...
/*******************************************************************************
 ...
 VALUES
    ...
    RAW_BUFFER   - Endpoint that provides a raw buffer without flow
                   ...
                   and played out.
    FILE_MGR     - Provides mechanism to download files from apps
...
typedef enum
{
    ...
    ACCMD_STREAM_DEVICE_FILE_MGR = 0x0080
} ACCMD_STREAM_DEVICE;
/*******************************************************************************
...
typedef enum
{
    ...
    ACCMD_ANC_CONTROL_ALL_MASK = 0x01FF
} ACCMD_ANC_CONTROL;
/*******************************************************************************
...
typedef enum
{
    ...
    ACCMD_ANC_DC_FILTER_MAX_SHIFT = 7
} ACCMD_ANC_DC_FILTER;
/*******************************************************************************
...
/*******************************************************************************
  ...
  NAME
    Accmd_rate_match_parameter

  DESCRIPTION
    Parameter to tune the behaviour of rate measurement and adjustment.

 VALUES
    ENABLE
                   - Enables the endpoint's rate matching support. The value is
                     a bit mask consisting of: 0x0001: Enable hardware
                     ratematching support. 0x0002: Enable software ratematching
                     support, The default is to enable any implemented
                     ratematching support.
    RATE_MEASUREMENT_INTEGRATION_LOG_COEFF
                   - default = 7
    RATE_MEASUREMENT_WHILE_ENACTING_ENABLE
                   - If this boolean flag is cleared (the default), an endpoint
                     which is capable of HW warp will report a measured rate
                     calculated from its warp value. If this flag is set, the
                     endpoint will also measure the rate and combine the result
                     with the calculated one. See
                     RATE_MEASUREMENT_WHILE_ENACTING_RANGE.
    RATE_MEASUREMENT_WHILE_ENACTING_RANGE
                   - If RATE_MEASUREMENT_WHILE_ENACTING_ENABLE is set, the
                     measured value is reported if the difference between the
                     calculated and measured value it is within
                     RATE_MEASUREMENT_WHILE_ENACTING_RANGE. The main reason for
                     this is that the measurement lags behind changes to the
                     warp value, depending on the values of
                     RATE_ADJUSTMENT_INTEGRATION_COEFF_0/1.
    RATE_ADJUSTMENT_INTEGRATION_COEFF_0
                   - value is fixpoint Q1.22
    RATE_ADJUSTMENT_INTEGRATION_COEFF_1
                   - value is fixpoint Q1.22
    RATE_ADJUSTMENT_DISCARD_IF_OUT_OF_RANGE
                   - If this boolean flag is cleared (the default), large
                     adjustment values are clipped to the supported range.
                     Setting this flag causes out-of-range adjustments to be
                     ignored instead.

*******************************************************************************/
typedef enum
{
    ACCMD_RATE_MATCH_PARAMETER_ENABLE = 0x0000,
    ACCMD_RATE_MATCH_PARAMETER_RATE_MEASUREMENT_INTEGRATION_LOG_COEFF = 0x10,
    ACCMD_RATE_MATCH_PARAMETER_RATE_MEASUREMENT_WHILE_ENACTING_ENABLE = 0x20,
    ACCMD_RATE_MATCH_PARAMETER_RATE_MEASUREMENT_WHILE_ENACTING_RANGE = 0x21,
    ACCMD_RATE_MATCH_PARAMETER_RATE_ADJUSTMENT_INTEGRATION_COEFF_0 = 0x30,
    ACCMD_RATE_MATCH_PARAMETER_RATE_ADJUSTMENT_INTEGRATION_COEFF_1 = 0x31,
    ACCMD_RATE_MATCH_PARAMETER_RATE_ADJUSTMENT_DISCARD_IF_OUT_OF_RANGE = 0x32
} ACCMD_RATE_MATCH_PARAMETER;
...
#define ACCMD_CODEC_IIR_FILTER_COEFF_MARSHALL(addr, accmd_codec_iir_filter_coeff_ptr) memcpy((void *)(addr), (void *)(accmd_codec_iir_filter_coeff_ptr), 1)
#define ACCMD_CODEC_IIR_FILTER_COEFF_UNMARSHALL(addr, accmd_codec_iir_filter_coeff_ptr) memcpy((void *)(accmd_codec_iir_filter_coeff_ptr), (void *)(addr), 1)
...
#define ACCMD_OPERATOR_CREATE_EX_INFO_MARSHALL(addr, accmd_operator_create_ex_info_ptr) memcpy((void *)(addr), (void *)(accmd_operator_create_ex_info_ptr), 3)
#define ACCMD_OPERATOR_CREATE_EX_INFO_UNMARSHALL(addr, accmd_operator_create_ex_info_ptr) memcpy((void *)(accmd_operator_create_ex_info_ptr), (void *)(addr), 3)
...
#define ACCMD_GET_OPERATORS_ENTRY_MARSHALL(addr, accmd_get_operators_entry_ptr) memcpy((void *)(addr), (void *)(accmd_get_operators_entry_ptr), 2)
#define ACCMD_GET_OPERATORS_ENTRY_UNMARSHALL(addr, accmd_get_operators_entry_ptr) memcpy((void *)(accmd_get_operators_entry_ptr), (void *)(addr), 2)
...
#define ACCMD_HEADER_MARSHALL(addr, accmd_header_ptr) memcpy((void *)(addr), (void *)(accmd_header_ptr), 3)
#define ACCMD_HEADER_UNMARSHALL(addr, accmd_header_ptr) memcpy((void *)(accmd_header_ptr), (void *)(addr), 3)
...
#define ACCMD_OP_MIPS_USAGE_MARSHALL(addr, accmd_op_mips_usage_ptr) memcpy((void *)(addr), (void *)(accmd_op_mips_usage_ptr), 2)
#define ACCMD_OP_MIPS_USAGE_UNMARSHALL(addr, accmd_op_mips_usage_ptr) memcpy((void *)(accmd_op_mips_usage_ptr), (void *)(addr), 2)
...
#define ACCMD_STREAM_GET_SOURCE_REQ_MARSHALL(addr, accmd_stream_get_source_req_ptr) memcpy((void *)(addr), (void *)(accmd_stream_get_source_req_ptr), 6)
#define ACCMD_STREAM_GET_SOURCE_REQ_UNMARSHALL(addr, accmd_stream_get_source_req_ptr) memcpy((void *)(accmd_stream_get_source_req_ptr), (void *)(addr), 6)
...
#define ACCMD_STREAM_GET_SINK_REQ_MARSHALL(addr, accmd_stream_get_sink_req_ptr) memcpy((void *)(addr), (void *)(accmd_stream_get_sink_req_ptr), 6)
#define ACCMD_STREAM_GET_SINK_REQ_UNMARSHALL(addr, accmd_stream_get_sink_req_ptr) memcpy((void *)(accmd_stream_get_sink_req_ptr), (void *)(addr), 6)
...
#define ACCMD_STREAM_CLOSE_SOURCE_REQ_MARSHALL(addr, accmd_stream_close_source_req_ptr) memcpy((void *)(addr), (void *)(accmd_stream_close_source_req_ptr), 4)
#define ACCMD_STREAM_CLOSE_SOURCE_REQ_UNMARSHALL(addr, accmd_stream_close_source_req_ptr) memcpy((void *)(accmd_stream_close_source_req_ptr), (void *)(addr), 4)
...
#define ACCMD_STREAM_CLOSE_SINK_REQ_MARSHALL(addr, accmd_stream_close_sink_req_ptr) memcpy((void *)(addr), (void *)(accmd_stream_close_sink_req_ptr), 4)
#define ACCMD_STREAM_CLOSE_SINK_REQ_UNMARSHALL(addr, accmd_stream_close_sink_req_ptr) memcpy((void *)(accmd_stream_close_sink_req_ptr), (void *)(addr), 4)
...
#define ACCMD_STREAM_CONFIGURE_REQ_MARSHALL(addr, accmd_stream_configure_req_ptr) memcpy((void *)(addr), (void *)(accmd_stream_configure_req_ptr), 7)
#define ACCMD_STREAM_CONFIGURE_REQ_UNMARSHALL(addr, accmd_stream_configure_req_ptr) memcpy((void *)(accmd_stream_configure_req_ptr), (void *)(addr), 7)
...
#define ACCMD_STREAM_SYNC_SID_REQ_MARSHALL(addr, accmd_stream_sync_sid_req_ptr) memcpy((void *)(addr), (void *)(accmd_stream_sync_sid_req_ptr), 5)
#define ACCMD_STREAM_SYNC_SID_REQ_UNMARSHALL(addr, accmd_stream_sync_sid_req_ptr) memcpy((void *)(accmd_stream_sync_sid_req_ptr), (void *)(addr), 5)
...
#define ACCMD_STREAM_CONNECT_REQ_MARSHALL(addr, accmd_stream_connect_req_ptr) memcpy((void *)(addr), (void *)(accmd_stream_connect_req_ptr), 5)
#define ACCMD_STREAM_CONNECT_REQ_UNMARSHALL(addr, accmd_stream_connect_req_ptr) memcpy((void *)(accmd_stream_connect_req_ptr), (void *)(addr), 5)
...
#define ACCMD_STREAM_TRANSFORM_DISCONNECT_REQ_MARSHALL(addr, accmd_stream_transform_disconnect_req_ptr) memcpy((void *)(addr), (void *)(accmd_stream_transform_disconnect_req_ptr), 4)
#define ACCMD_STREAM_TRANSFORM_DISCONNECT_REQ_UNMARSHALL(addr, accmd_stream_transform_disconnect_req_ptr) memcpy((void *)(accmd_stream_transform_disconnect_req_ptr), (void *)(addr), 4)
...
#define ACCMD_CREATE_OPERATOR_REQ_MARSHALL(addr, accmd_create_operator_req_ptr) memcpy((void *)(addr), (void *)(accmd_create_operator_req_ptr), 4)
#define ACCMD_CREATE_OPERATOR_REQ_UNMARSHALL(addr, accmd_create_operator_req_ptr) memcpy((void *)(accmd_create_operator_req_ptr), (void *)(addr), 4)
...
#define ACCMD_DESTROY_OPERATORS_REQ_MARSHALL(addr, accmd_destroy_operators_req_ptr) memcpy((void *)(addr), (void *)(accmd_destroy_operators_req_ptr), 5)
#define ACCMD_DESTROY_OPERATORS_REQ_UNMARSHALL(addr, accmd_destroy_operators_req_ptr) memcpy((void *)(accmd_destroy_operators_req_ptr), (void *)(addr), 5)
...
#define ACCMD_OPERATOR_MESSAGE_REQ_MARSHALL(addr, accmd_operator_message_req_ptr) memcpy((void *)(addr), (void *)(accmd_operator_message_req_ptr), 5)
#define ACCMD_OPERATOR_MESSAGE_REQ_UNMARSHALL(addr, accmd_operator_message_req_ptr) memcpy((void *)(accmd_operator_message_req_ptr), (void *)(addr), 5)
...
#define ACCMD_START_OPERATORS_REQ_MARSHALL(addr, accmd_start_operators_req_ptr) memcpy((void *)(addr), (void *)(accmd_start_operators_req_ptr), 5)
#define ACCMD_START_OPERATORS_REQ_UNMARSHALL(addr, accmd_start_operators_req_ptr) memcpy((void *)(accmd_start_operators_req_ptr), (void *)(addr), 5)
...
#define ACCMD_STOP_OPERATORS_REQ_MARSHALL(addr, accmd_stop_operators_req_ptr) memcpy((void *)(addr), (void *)(accmd_stop_operators_req_ptr), 5)
#define ACCMD_STOP_OPERATORS_REQ_UNMARSHALL(addr, accmd_stop_operators_req_ptr) memcpy((void *)(accmd_stop_operators_req_ptr), (void *)(addr), 5)
...
#define ACCMD_RESET_OPERATORS_REQ_MARSHALL(addr, accmd_reset_operators_req_ptr) memcpy((void *)(addr), (void *)(accmd_reset_operators_req_ptr), 5)
#define ACCMD_RESET_OPERATORS_REQ_UNMARSHALL(addr, accmd_reset_operators_req_ptr) memcpy((void *)(accmd_reset_operators_req_ptr), (void *)(addr), 5)
...
#define ACCMD_MESSAGE_FROM_OPERATOR_REQ_MARSHALL(addr, accmd_message_from_operator_req_ptr) memcpy((void *)(addr), (void *)(accmd_message_from_operator_req_ptr), 5)
#define ACCMD_MESSAGE_FROM_OPERATOR_REQ_UNMARSHALL(addr, accmd_message_from_operator_req_ptr) memcpy((void *)(accmd_message_from_operator_req_ptr), (void *)(addr), 5)
...
#define ACCMD_STREAM_GET_INFO_REQ_MARSHALL(addr, accmd_stream_get_info_req_ptr) memcpy((void *)(addr), (void *)(accmd_stream_get_info_req_ptr), 5)
#define ACCMD_STREAM_GET_INFO_REQ_UNMARSHALL(addr, accmd_stream_get_info_req_ptr) memcpy((void *)(accmd_stream_get_info_req_ptr), (void *)(addr), 5)
...
#define ACCMD_GET_CAPABILITIES_REQ_MARSHALL(addr, accmd_get_capabilities_req_ptr) memcpy((void *)(addr), (void *)(accmd_get_capabilities_req_ptr), 4)
#define ACCMD_GET_CAPABILITIES_REQ_UNMARSHALL(addr, accmd_get_capabilities_req_ptr) memcpy((void *)(accmd_get_capabilities_req_ptr), (void *)(addr), 4)
...
#define ACCMD_STREAM_EXTERNAL_DETACH_REQ_MARSHALL(addr, accmd_stream_external_detach_req_ptr) memcpy((void *)(addr), (void *)(accmd_stream_external_detach_req_ptr), 4)
#define ACCMD_STREAM_EXTERNAL_DETACH_REQ_UNMARSHALL(addr, accmd_stream_external_detach_req_ptr) memcpy((void *)(accmd_stream_external_detach_req_ptr), (void *)(addr), 4)
...
#define ACCMD_STREAM_SOURCE_DRAINED_REQ_MARSHALL(addr, accmd_stream_source_drained_req_ptr) memcpy((void *)(addr), (void *)(accmd_stream_source_drained_req_ptr), 4)
#define ACCMD_STREAM_SOURCE_DRAINED_REQ_UNMARSHALL(addr, accmd_stream_source_drained_req_ptr) memcpy((void *)(accmd_stream_source_drained_req_ptr), (void *)(addr), 4)
...
#define ACCMD_CREATE_OPERATOR_EX_REQ_MARSHALL(addr, accmd_create_operator_ex_req_ptr) memcpy((void *)(addr), (void *)(accmd_create_operator_ex_req_ptr), 8)
#define ACCMD_CREATE_OPERATOR_EX_REQ_UNMARSHALL(addr, accmd_create_operator_ex_req_ptr) memcpy((void *)(accmd_create_operator_ex_req_ptr), (void *)(addr), 8)
...
#define ACCMD_GET_MEM_USAGE_REQ_MARSHALL(addr, accmd_get_mem_usage_req_ptr) memcpy((void *)(addr), (void *)(accmd_get_mem_usage_req_ptr), 4)
#define ACCMD_GET_MEM_USAGE_REQ_UNMARSHALL(addr, accmd_get_mem_usage_req_ptr) memcpy((void *)(accmd_get_mem_usage_req_ptr), (void *)(addr), 4)
...
#define ACCMD_GET_MIPS_USAGE_REQ_MARSHALL(addr, accmd_get_mips_usage_req_ptr) memcpy((void *)(addr), (void *)(accmd_get_mips_usage_req_ptr), 5)
#define ACCMD_GET_MIPS_USAGE_REQ_UNMARSHALL(addr, accmd_get_mips_usage_req_ptr) memcpy((void *)(accmd_get_mips_usage_req_ptr), (void *)(addr), 5)
...
#define ACCMD_SET_SYSTEM_STREAM_RATE_REQ_MARSHALL(addr, accmd_set_system_stream_rate_req_ptr) memcpy((void *)(addr), (void *)(accmd_set_system_stream_rate_req_ptr), 5)
#define ACCMD_SET_SYSTEM_STREAM_RATE_REQ_UNMARSHALL(addr, accmd_set_system_stream_rate_req_ptr) memcpy((void *)(accmd_set_system_stream_rate_req_ptr), (void *)(addr), 5)
...
#define ACCMD_STREAM_DISCONNECT_REQ_MARSHALL(addr, accmd_stream_disconnect_req_ptr) memcpy((void *)(addr), (void *)(accmd_stream_disconnect_req_ptr), 5)
#define ACCMD_STREAM_DISCONNECT_REQ_UNMARSHALL(addr, accmd_stream_disconnect_req_ptr) memcpy((void *)(accmd_stream_disconnect_req_ptr), (void *)(addr), 5)
...
#define ACCMD_STREAM_GET_SINK_FROM_SOURCE_REQ_MARSHALL(addr, accmd_stream_get_sink_from_source_req_ptr) memcpy((void *)(addr), (void *)(accmd_stream_get_sink_from_source_req_ptr), 4)
#define ACCMD_STREAM_GET_SINK_FROM_SOURCE_REQ_UNMARSHALL(addr, accmd_stream_get_sink_from_source_req_ptr) memcpy((void *)(accmd_stream_get_sink_from_source_req_ptr), (void *)(addr), 4)
...
#define ACCMD_STREAM_GET_SOURCE_FROM_SINK_REQ_MARSHALL(addr, accmd_stream_get_source_from_sink_req_ptr) memcpy((void *)(addr), (void *)(accmd_stream_get_source_from_sink_req_ptr), 4)
#define ACCMD_STREAM_GET_SOURCE_FROM_SINK_REQ_UNMARSHALL(addr, accmd_stream_get_source_from_sink_req_ptr) memcpy((void *)(accmd_stream_get_source_from_sink_req_ptr), (void *)(addr), 4)
...
#define ACCMD_CAP_DOWNLOAD_REMOVE_KCS_REQ_MARSHALL(addr, accmd_cap_download_remove_kcs_req_ptr) memcpy((void *)(addr), (void *)(accmd_cap_download_remove_kcs_req_ptr), 4)
#define ACCMD_CAP_DOWNLOAD_REMOVE_KCS_REQ_UNMARSHALL(addr, accmd_cap_download_remove_kcs_req_ptr) memcpy((void *)(accmd_cap_download_remove_kcs_req_ptr), (void *)(addr), 4)
...
#define ACCMD_SET_SYSTEM_FRAMEWORK_REQ_MARSHALL(addr, accmd_set_system_framework_req_ptr) memcpy((void *)(addr), (void *)(accmd_set_system_framework_req_ptr), 5)
#define ACCMD_SET_SYSTEM_FRAMEWORK_REQ_UNMARSHALL(addr, accmd_set_system_framework_req_ptr) memcpy((void *)(accmd_set_system_framework_req_ptr), (void *)(addr), 5)
...
#define ACCMD_GET_SYSTEM_FRAMEWORK_REQ_MARSHALL(addr, accmd_get_system_framework_req_ptr) memcpy((void *)(addr), (void *)(accmd_get_system_framework_req_ptr), 5)
#define ACCMD_GET_SYSTEM_FRAMEWORK_REQ_UNMARSHALL(addr, accmd_get_system_framework_req_ptr) memcpy((void *)(accmd_get_system_framework_req_ptr), (void *)(addr), 5)
...
#define ACCMD_UNSOLICITED_SYSTEM_FRAMEWORK_REQ_MARSHALL(addr, accmd_unsolicited_system_framework_req_ptr) memcpy((void *)(addr), (void *)(accmd_unsolicited_system_framework_req_ptr), 5)
#define ACCMD_UNSOLICITED_SYSTEM_FRAMEWORK_REQ_UNMARSHALL(addr, accmd_unsolicited_system_framework_req_ptr) memcpy((void *)(accmd_unsolicited_system_framework_req_ptr), (void *)(addr), 5)
...
#define ACCMD_MIC_BIAS_CONFIGURE_REQ_MARSHALL(addr, accmd_mic_bias_configure_req_ptr) memcpy((void *)(addr), (void *)(accmd_mic_bias_configure_req_ptr), 7)
#define ACCMD_MIC_BIAS_CONFIGURE_REQ_UNMARSHALL(addr, accmd_mic_bias_configure_req_ptr) memcpy((void *)(accmd_mic_bias_configure_req_ptr), (void *)(addr), 7)
...
#define ACCMD_CODEC_SET_IIR_FILTER_REQ_MARSHALL(addr, accmd_codec_set_iir_filter_req_ptr) memcpy((void *)(addr), (void *)(accmd_codec_set_iir_filter_req_ptr), 7)
#define ACCMD_CODEC_SET_IIR_FILTER_REQ_UNMARSHALL(addr, accmd_codec_set_iir_filter_req_ptr) memcpy((void *)(accmd_codec_set_iir_filter_req_ptr), (void *)(addr), 7)
...
#define ACCMD_CODEC_SET_IIR_FILTER_16BIT_REQ_MARSHALL(addr, accmd_codec_set_iir_filter_16bit_req_ptr) memcpy((void *)(addr), (void *)(accmd_codec_set_iir_filter_16bit_req_ptr), 7)
#define ACCMD_CODEC_SET_IIR_FILTER_16BIT_REQ_UNMARSHALL(addr, accmd_codec_set_iir_filter_16bit_req_ptr) memcpy((void *)(accmd_codec_set_iir_filter_16bit_req_ptr), (void *)(addr), 7)
...
#define ACCMD_AUX_PROCESSOR_LOAD_REQ_MARSHALL(addr, accmd_aux_processor_load_req_ptr) memcpy((void *)(addr), (void *)(accmd_aux_processor_load_req_ptr), 7)
#define ACCMD_AUX_PROCESSOR_LOAD_REQ_UNMARSHALL(addr, accmd_aux_processor_load_req_ptr) memcpy((void *)(accmd_aux_processor_load_req_ptr), (void *)(addr), 7)
...
#define ACCMD_AUX_PROCESSOR_START_REQ_MARSHALL(addr, accmd_aux_processor_start_req_ptr) memcpy((void *)(addr), (void *)(accmd_aux_processor_start_req_ptr), 4)
#define ACCMD_AUX_PROCESSOR_START_REQ_UNMARSHALL(addr, accmd_aux_processor_start_req_ptr) memcpy((void *)(accmd_aux_processor_start_req_ptr), (void *)(addr), 4)
...
#define ACCMD_AUX_PROCESSOR_STOP_REQ_MARSHALL(addr, accmd_aux_processor_stop_req_ptr) memcpy((void *)(addr), (void *)(accmd_aux_processor_stop_req_ptr), 4)
#define ACCMD_AUX_PROCESSOR_STOP_REQ_UNMARSHALL(addr, accmd_aux_processor_stop_req_ptr) memcpy((void *)(accmd_aux_processor_stop_req_ptr), (void *)(addr), 4)
...
#define ACCMD_STREAM_MCLK_ACTIVATE_REQ_MARSHALL(addr, accmd_stream_mclk_activate_req_ptr) memcpy((void *)(addr), (void *)(accmd_stream_mclk_activate_req_ptr), 6)
#define ACCMD_STREAM_MCLK_ACTIVATE_REQ_UNMARSHALL(addr, accmd_stream_mclk_activate_req_ptr) memcpy((void *)(accmd_stream_mclk_activate_req_ptr), (void *)(addr), 6)
...
#define ACCMD_SET_MCLK_SOURCE_TYPE_REQ_MARSHALL(addr, accmd_set_mclk_source_type_req_ptr) memcpy((void *)(addr), (void *)(accmd_set_mclk_source_type_req_ptr), 6)
#define ACCMD_SET_MCLK_SOURCE_TYPE_REQ_UNMARSHALL(addr, accmd_set_mclk_source_type_req_ptr) memcpy((void *)(accmd_set_mclk_source_type_req_ptr), (void *)(addr), 6)
...
#define ACCMD_GET_OPERATORS_REQ_MARSHALL(addr, accmd_get_operators_req_ptr) memcpy((void *)(addr), (void *)(accmd_get_operators_req_ptr), 5)
#define ACCMD_GET_OPERATORS_REQ_UNMARSHALL(addr, accmd_get_operators_req_ptr) memcpy((void *)(accmd_get_operators_req_ptr), (void *)(addr), 5)
...
#define ACCMD_PS_READ_REQ_MARSHALL(addr, accmd_ps_read_req_ptr) memcpy((void *)(addr), (void *)(accmd_ps_read_req_ptr), 6)
#define ACCMD_PS_READ_REQ_UNMARSHALL(addr, accmd_ps_read_req_ptr) memcpy((void *)(accmd_ps_read_req_ptr), (void *)(addr), 6)
...
#define ACCMD_PS_WRITE_REQ_MARSHALL(addr, accmd_ps_write_req_ptr) memcpy((void *)(addr), (void *)(accmd_ps_write_req_ptr), 8)
#define ACCMD_PS_WRITE_REQ_UNMARSHALL(addr, accmd_ps_write_req_ptr) memcpy((void *)(accmd_ps_write_req_ptr), (void *)(addr), 8)
...
#define ACCMD_PS_DELETE_REQ_MARSHALL(addr, accmd_ps_delete_req_ptr) memcpy((void *)(addr), (void *)(accmd_ps_delete_req_ptr), 5)
#define ACCMD_PS_DELETE_REQ_UNMARSHALL(addr, accmd_ps_delete_req_ptr) memcpy((void *)(accmd_ps_delete_req_ptr), (void *)(addr), 5)
...
#define ACCMD_CLOCK_CONFIGURE_REQ_MARSHALL(addr, accmd_clock_configure_req_ptr) memcpy((void *)(addr), (void *)(accmd_clock_configure_req_ptr), 6)
#define ACCMD_CLOCK_CONFIGURE_REQ_UNMARSHALL(addr, accmd_clock_configure_req_ptr) memcpy((void *)(accmd_clock_configure_req_ptr), (void *)(addr), 6)
...
#define ACCMD_SET_ANC_IIR_FILTER_REQ_MARSHALL(addr, accmd_set_anc_iir_filter_req_ptr) memcpy((void *)(addr), (void *)(accmd_set_anc_iir_filter_req_ptr), 7)
#define ACCMD_SET_ANC_IIR_FILTER_REQ_UNMARSHALL(addr, accmd_set_anc_iir_filter_req_ptr) memcpy((void *)(accmd_set_anc_iir_filter_req_ptr), (void *)(addr), 7)
...
#define ACCMD_SET_ANC_LPF_FILTER_REQ_MARSHALL(addr, accmd_set_anc_lpf_filter_req_ptr) memcpy((void *)(addr), (void *)(accmd_set_anc_lpf_filter_req_ptr), 7)
#define ACCMD_SET_ANC_LPF_FILTER_REQ_UNMARSHALL(addr, accmd_set_anc_lpf_filter_req_ptr) memcpy((void *)(accmd_set_anc_lpf_filter_req_ptr), (void *)(addr), 7)
...
#define ACCMD_STREAM_ANC_ENABLE_REQ_MARSHALL(addr, accmd_stream_anc_enable_req_ptr) memcpy((void *)(addr), (void *)(accmd_stream_anc_enable_req_ptr), 5)
#define ACCMD_STREAM_ANC_ENABLE_REQ_UNMARSHALL(addr, accmd_stream_anc_enable_req_ptr) memcpy((void *)(accmd_stream_anc_enable_req_ptr), (void *)(addr), 5)
...
#define ACCMD_STREAM_SIDETONE_EN_REQ_MARSHALL(addr, accmd_stream_sidetone_en_req_ptr) memcpy((void *)(addr), (void *)(accmd_stream_sidetone_en_req_ptr), 4)
#define ACCMD_STREAM_SIDETONE_EN_REQ_UNMARSHALL(addr, accmd_stream_sidetone_en_req_ptr) memcpy((void *)(accmd_stream_sidetone_en_req_ptr), (void *)(addr), 4)
...
#define ACCMD_DATA_FILE_ALLOCATE_REQ_MARSHALL(addr, accmd_data_file_allocate_req_ptr) memcpy((void *)(addr), (void *)(accmd_data_file_allocate_req_ptr), 7)
#define ACCMD_DATA_FILE_ALLOCATE_REQ_UNMARSHALL(addr, accmd_data_file_allocate_req_ptr) memcpy((void *)(accmd_data_file_allocate_req_ptr), (void *)(addr), 7)
...
#define ACCMD_DATA_FILE_DEALLOCATE_REQ_MARSHALL(addr, accmd_data_file_deallocate_req_ptr) memcpy((void *)(addr), (void *)(accmd_data_file_deallocate_req_ptr), 4)
#define ACCMD_DATA_FILE_DEALLOCATE_REQ_UNMARSHALL(addr, accmd_data_file_deallocate_req_ptr) memcpy((void *)(accmd_data_file_deallocate_req_ptr), (void *)(addr), 4)
...
#define ACCMD_CLOCK_POWER_SAVE_MODE_REQ_MARSHALL(addr, accmd_clock_power_save_mode_req_ptr) memcpy((void *)(addr), (void *)(accmd_clock_power_save_mode_req_ptr), 4)
#define ACCMD_CLOCK_POWER_SAVE_MODE_REQ_UNMARSHALL(addr, accmd_clock_power_save_mode_req_ptr) memcpy((void *)(accmd_clock_power_save_mode_req_ptr), (void *)(addr), 4)
...
#define ACCMD_AUX_PROCESSOR_DISABLE_REQ_MARSHALL(addr, accmd_aux_processor_disable_req_ptr) memcpy((void *)(addr), (void *)(accmd_aux_processor_disable_req_ptr), 4)
#define ACCMD_AUX_PROCESSOR_DISABLE_REQ_UNMARSHALL(addr, accmd_aux_processor_disable_req_ptr) memcpy((void *)(accmd_aux_processor_disable_req_ptr), (void *)(addr), 4)
...
#define ACCMD_SET_PANIC_CODE_REQ_MARSHALL(addr, accmd_set_panic_code_req_ptr) memcpy((void *)(addr), (void *)(accmd_set_panic_code_req_ptr), 5)
#define ACCMD_SET_PANIC_CODE_REQ_UNMARSHALL(addr, accmd_set_panic_code_req_ptr) memcpy((void *)(accmd_set_panic_code_req_ptr), (void *)(addr), 5)
...
#define ACCMD_SET_FAULT_CODE_REQ_MARSHALL(addr, accmd_set_fault_code_req_ptr) memcpy((void *)(addr), (void *)(accmd_set_fault_code_req_ptr), 5)
#define ACCMD_SET_FAULT_CODE_REQ_UNMARSHALL(addr, accmd_set_fault_code_req_ptr) memcpy((void *)(accmd_set_fault_code_req_ptr), (void *)(addr), 5)
...
#define ACCMD_SET_IPC_INTERFACE_TEST_REQ_MARSHALL(addr, accmd_set_ipc_interface_test_req_ptr) memcpy((void *)(addr), (void *)(accmd_set_ipc_interface_test_req_ptr), 4)
#define ACCMD_SET_IPC_INTERFACE_TEST_REQ_UNMARSHALL(addr, accmd_set_ipc_interface_test_req_ptr) memcpy((void *)(accmd_set_ipc_interface_test_req_ptr), (void *)(addr), 4)
...
#define ACCMD_CALL_FUNCTION_REQ_MARSHALL(addr, accmd_call_function_req_ptr) memcpy((void *)(addr), (void *)(accmd_call_function_req_ptr), 8)
#define ACCMD_CALL_FUNCTION_REQ_UNMARSHALL(addr, accmd_call_function_req_ptr) memcpy((void *)(accmd_call_function_req_ptr), (void *)(addr), 8)
...
#define ACCMD_STREAM_GET_SOURCE_RESP_MARSHALL(addr, accmd_stream_get_source_resp_ptr) memcpy((void *)(addr), (void *)(accmd_stream_get_source_resp_ptr), 5)
#define ACCMD_STREAM_GET_SOURCE_RESP_UNMARSHALL(addr, accmd_stream_get_source_resp_ptr) memcpy((void *)(accmd_stream_get_source_resp_ptr), (void *)(addr), 5)
...
#define ACCMD_STREAM_GET_SINK_RESP_MARSHALL(addr, accmd_stream_get_sink_resp_ptr) memcpy((void *)(addr), (void *)(accmd_stream_get_sink_resp_ptr), 5)
#define ACCMD_STREAM_GET_SINK_RESP_UNMARSHALL(addr, accmd_stream_get_sink_resp_ptr) memcpy((void *)(accmd_stream_get_sink_resp_ptr), (void *)(addr), 5)
...
#define ACCMD_STANDARD_RESP_MARSHALL(addr, accmd_standard_resp_ptr) memcpy((void *)(addr), (void *)(accmd_standard_resp_ptr), 4)
#define ACCMD_STANDARD_RESP_UNMARSHALL(addr, accmd_standard_resp_ptr) memcpy((void *)(accmd_standard_resp_ptr), (void *)(addr), 4)
...
#define ACCMD_STREAM_CONNECT_RESP_MARSHALL(addr, accmd_stream_connect_resp_ptr) memcpy((void *)(addr), (void *)(accmd_stream_connect_resp_ptr), 5)
#define ACCMD_STREAM_CONNECT_RESP_UNMARSHALL(addr, accmd_stream_connect_resp_ptr) memcpy((void *)(accmd_stream_connect_resp_ptr), (void *)(addr), 5)
...
#define ACCMD_GET_FIRMWARE_VERSION_RESP_MARSHALL(addr, accmd_get_firmware_version_resp_ptr) memcpy((void *)(addr), (void *)(accmd_get_firmware_version_resp_ptr), 5)
#define ACCMD_GET_FIRMWARE_VERSION_RESP_UNMARSHALL(addr, accmd_get_firmware_version_resp_ptr) memcpy((void *)(accmd_get_firmware_version_resp_ptr), (void *)(addr), 5)
...
#define ACCMD_CREATE_OPERATOR_RESP_MARSHALL(addr, accmd_create_operator_resp_ptr) memcpy((void *)(addr), (void *)(accmd_create_operator_resp_ptr), 5)
#define ACCMD_CREATE_OPERATOR_RESP_UNMARSHALL(addr, accmd_create_operator_resp_ptr) memcpy((void *)(accmd_create_operator_resp_ptr), (void *)(addr), 5)
...
#define ACCMD_DESTROY_OPERATORS_RESP_MARSHALL(addr, accmd_destroy_operators_resp_ptr) memcpy((void *)(addr), (void *)(accmd_destroy_operators_resp_ptr), 6)
#define ACCMD_DESTROY_OPERATORS_RESP_UNMARSHALL(addr, accmd_destroy_operators_resp_ptr) memcpy((void *)(accmd_destroy_operators_resp_ptr), (void *)(addr), 6)
...
#define ACCMD_OPERATOR_MESSAGE_RESP_MARSHALL(addr, accmd_operator_message_resp_ptr) memcpy((void *)(addr), (void *)(accmd_operator_message_resp_ptr), 6)
#define ACCMD_OPERATOR_MESSAGE_RESP_UNMARSHALL(addr, accmd_operator_message_resp_ptr) memcpy((void *)(accmd_operator_message_resp_ptr), (void *)(addr), 6)
...
#define ACCMD_START_OPERATORS_RESP_MARSHALL(addr, accmd_start_operators_resp_ptr) memcpy((void *)(addr), (void *)(accmd_start_operators_resp_ptr), 6)
#define ACCMD_START_OPERATORS_RESP_UNMARSHALL(addr, accmd_start_operators_resp_ptr) memcpy((void *)(accmd_start_operators_resp_ptr), (void *)(addr), 6)
...
#define ACCMD_STOP_OPERATORS_RESP_MARSHALL(addr, accmd_stop_operators_resp_ptr) memcpy((void *)(addr), (void *)(accmd_stop_operators_resp_ptr), 6)
#define ACCMD_STOP_OPERATORS_RESP_UNMARSHALL(addr, accmd_stop_operators_resp_ptr) memcpy((void *)(accmd_stop_operators_resp_ptr), (void *)(addr), 6)
...
#define ACCMD_RESET_OPERATORS_RESP_MARSHALL(addr, accmd_reset_operators_resp_ptr) memcpy((void *)(addr), (void *)(accmd_reset_operators_resp_ptr), 6)
#define ACCMD_RESET_OPERATORS_RESP_UNMARSHALL(addr, accmd_reset_operators_resp_ptr) memcpy((void *)(accmd_reset_operators_resp_ptr), (void *)(addr), 6)
...
#define ACCMD_GET_FIRMWARE_ID_STRING_RESP_MARSHALL(addr, accmd_get_firmware_id_string_resp_ptr) memcpy((void *)(addr), (void *)(accmd_get_firmware_id_string_resp_ptr), 6)
#define ACCMD_GET_FIRMWARE_ID_STRING_RESP_UNMARSHALL(addr, accmd_get_firmware_id_string_resp_ptr) memcpy((void *)(accmd_get_firmware_id_string_resp_ptr), (void *)(addr), 6)
...
#define ACCMD_AUDIO_PRODTEST_RESP_MARSHALL(addr, accmd_audio_prodtest_resp_ptr) memcpy((void *)(addr), (void *)(accmd_audio_prodtest_resp_ptr), 5)
#define ACCMD_AUDIO_PRODTEST_RESP_UNMARSHALL(addr, accmd_audio_prodtest_resp_ptr) memcpy((void *)(accmd_audio_prodtest_resp_ptr), (void *)(addr), 5)
...
#define ACCMD_STREAM_GET_INFO_RESP_MARSHALL(addr, accmd_stream_get_info_resp_ptr) memcpy((void *)(addr), (void *)(accmd_stream_get_info_resp_ptr), 6)
#define ACCMD_STREAM_GET_INFO_RESP_UNMARSHALL(addr, accmd_stream_get_info_resp_ptr) memcpy((void *)(accmd_stream_get_info_resp_ptr), (void *)(addr), 6)
...
#define ACCMD_GET_CAPABILITIES_RESP_MARSHALL(addr, accmd_get_capabilities_resp_ptr) memcpy((void *)(addr), (void *)(accmd_get_capabilities_resp_ptr), 7)
#define ACCMD_GET_CAPABILITIES_RESP_UNMARSHALL(addr, accmd_get_capabilities_resp_ptr) memcpy((void *)(accmd_get_capabilities_resp_ptr), (void *)(addr), 7)
...
#define ACCMD_CREATE_OPERATOR_EX_RESP_MARSHALL(addr, accmd_create_operator_ex_resp_ptr) memcpy((void *)(addr), (void *)(accmd_create_operator_ex_resp_ptr), 5)
#define ACCMD_CREATE_OPERATOR_EX_RESP_UNMARSHALL(addr, accmd_create_operator_ex_resp_ptr) memcpy((void *)(accmd_create_operator_ex_resp_ptr), (void *)(addr), 5)
...
#define ACCMD_GET_MEM_USAGE_RESP_MARSHALL(addr, accmd_get_mem_usage_resp_ptr) memcpy((void *)(addr), (void *)(accmd_get_mem_usage_resp_ptr), 16)
#define ACCMD_GET_MEM_USAGE_RESP_UNMARSHALL(addr, accmd_get_mem_usage_resp_ptr) memcpy((void *)(accmd_get_mem_usage_resp_ptr), (void *)(addr), 16)
...
#define ACCMD_CLEAR_MEM_WATERMARKS_RESP_MARSHALL(addr, accmd_clear_mem_watermarks_resp_ptr) memcpy((void *)(addr), (void *)(accmd_clear_mem_watermarks_resp_ptr), 4)
#define ACCMD_CLEAR_MEM_WATERMARKS_RESP_UNMARSHALL(addr, accmd_clear_mem_watermarks_resp_ptr) memcpy((void *)(accmd_clear_mem_watermarks_resp_ptr), (void *)(addr), 4)
...
#define ACCMD_GET_MIPS_USAGE_RESP_MARSHALL(addr, accmd_get_mips_usage_resp_ptr) memcpy((void *)(addr), (void *)(accmd_get_mips_usage_resp_ptr), 8)
#define ACCMD_GET_MIPS_USAGE_RESP_UNMARSHALL(addr, accmd_get_mips_usage_resp_ptr) memcpy((void *)(accmd_get_mips_usage_resp_ptr), (void *)(addr), 8)
...
#define ACCMD_SET_SYSTEM_STREAM_RATE_RESP_MARSHALL(addr, accmd_set_system_stream_rate_resp_ptr) memcpy((void *)(addr), (void *)(accmd_set_system_stream_rate_resp_ptr), 4)
#define ACCMD_SET_SYSTEM_STREAM_RATE_RESP_UNMARSHALL(addr, accmd_set_system_stream_rate_resp_ptr) memcpy((void *)(accmd_set_system_stream_rate_resp_ptr), (void *)(addr), 4)
...
#define ACCMD_GET_SYSTEM_STREAM_RATE_RESP_MARSHALL(addr, accmd_get_system_stream_rate_resp_ptr) memcpy((void *)(addr), (void *)(accmd_get_system_stream_rate_resp_ptr), 6)
#define ACCMD_GET_SYSTEM_STREAM_RATE_RESP_UNMARSHALL(addr, accmd_get_system_stream_rate_resp_ptr) memcpy((void *)(accmd_get_system_stream_rate_resp_ptr), (void *)(addr), 6)
...
#define ACCMD_STREAM_DISCONNECT_RESP_MARSHALL(addr, accmd_stream_disconnect_resp_ptr) memcpy((void *)(addr), (void *)(accmd_stream_disconnect_resp_ptr), 6)
#define ACCMD_STREAM_DISCONNECT_RESP_UNMARSHALL(addr, accmd_stream_disconnect_resp_ptr) memcpy((void *)(accmd_stream_disconnect_resp_ptr), (void *)(addr), 6)
...
#define ACCMD_STREAM_GET_SINK_FROM_SOURCE_RESP_MARSHALL(addr, accmd_stream_get_sink_from_source_resp_ptr) memcpy((void *)(addr), (void *)(accmd_stream_get_sink_from_source_resp_ptr), 5)
#define ACCMD_STREAM_GET_SINK_FROM_SOURCE_RESP_UNMARSHALL(addr, accmd_stream_get_sink_from_source_resp_ptr) memcpy((void *)(accmd_stream_get_sink_from_source_resp_ptr), (void *)(addr), 5)
...
#define ACCMD_STREAM_GET_SOURCE_FROM_SINK_RESP_MARSHALL(addr, accmd_stream_get_source_from_sink_resp_ptr) memcpy((void *)(addr), (void *)(accmd_stream_get_source_from_sink_resp_ptr), 5)
#define ACCMD_STREAM_GET_SOURCE_FROM_SINK_RESP_UNMARSHALL(addr, accmd_stream_get_source_from_sink_resp_ptr) memcpy((void *)(accmd_stream_get_source_from_sink_resp_ptr), (void *)(addr), 5)
...
#define ACCMD_SET_SYSTEM_FRAMEWORK_RESP_MARSHALL(addr, accmd_set_system_framework_resp_ptr) memcpy((void *)(addr), (void *)(accmd_set_system_framework_resp_ptr), 4)
#define ACCMD_SET_SYSTEM_FRAMEWORK_RESP_UNMARSHALL(addr, accmd_set_system_framework_resp_ptr) memcpy((void *)(accmd_set_system_framework_resp_ptr), (void *)(addr), 4)
...
#define ACCMD_GET_SYSTEM_FRAMEWORK_RESP_MARSHALL(addr, accmd_get_system_framework_resp_ptr) memcpy((void *)(addr), (void *)(accmd_get_system_framework_resp_ptr), 5)
#define ACCMD_GET_SYSTEM_FRAMEWORK_RESP_UNMARSHALL(addr, accmd_get_system_framework_resp_ptr) memcpy((void *)(accmd_get_system_framework_resp_ptr), (void *)(addr), 5)
...
#define ACCMD_GET_IPC_INTERFACE_TEST_RESP_MARSHALL(addr, accmd_get_ipc_interface_test_resp_ptr) memcpy((void *)(addr), (void *)(accmd_get_ipc_interface_test_resp_ptr), 5)
#define ACCMD_GET_IPC_INTERFACE_TEST_RESP_UNMARSHALL(addr, accmd_get_ipc_interface_test_resp_ptr) memcpy((void *)(accmd_get_ipc_interface_test_resp_ptr), (void *)(addr), 5)
...
#define ACCMD_GET_OPERATORS_RESP_MARSHALL(addr, accmd_get_operators_resp_ptr) memcpy((void *)(addr), (void *)(accmd_get_operators_resp_ptr), 8)
#define ACCMD_GET_OPERATORS_RESP_UNMARSHALL(addr, accmd_get_operators_resp_ptr) memcpy((void *)(accmd_get_operators_resp_ptr), (void *)(addr), 8)
...
#define ACCMD_PS_READ_RESP_MARSHALL(addr, accmd_ps_read_resp_ptr) memcpy((void *)(addr), (void *)(accmd_ps_read_resp_ptr), 6)
#define ACCMD_PS_READ_RESP_UNMARSHALL(addr, accmd_ps_read_resp_ptr) memcpy((void *)(accmd_ps_read_resp_ptr), (void *)(addr), 6)
...
#define ACCMD_PS_WRITE_RESP_MARSHALL(addr, accmd_ps_write_resp_ptr) memcpy((void *)(addr), (void *)(accmd_ps_write_resp_ptr), 4)
#define ACCMD_PS_WRITE_RESP_UNMARSHALL(addr, accmd_ps_write_resp_ptr) memcpy((void *)(accmd_ps_write_resp_ptr), (void *)(addr), 4)
...
#define ACCMD_CLOCK_CONFIGURE_RESP_LOW_POWER_MODE_CLK_GET(addr) ((ACCMD_CPU_CLK)*((addr) + 4))
...
#define ACCMD_CLOCK_CONFIGURE_RESP_WAKE_ON_MODE_CLK_GET(addr) ((ACCMD_CPU_CLK)*((addr) + 5))
...
#define ACCMD_CLOCK_CONFIGURE_RESP_ACTIVE_MODE_CLK_GET(addr) ((ACCMD_CPU_CLK)*((addr) + 6))
...
#define ACCMD_CLOCK_CONFIGURE_RESP_MARSHALL(addr, accmd_clock_configure_resp_ptr) memcpy((void *)(addr), (void *)(accmd_clock_configure_resp_ptr), 7)
#define ACCMD_CLOCK_CONFIGURE_RESP_UNMARSHALL(addr, accmd_clock_configure_resp_ptr) memcpy((void *)(accmd_clock_configure_resp_ptr), (void *)(addr), 7)
...
#define ACCMD_DATA_FILE_ALLOCATE_RESP_MARSHALL(addr, accmd_data_file_allocate_resp_ptr) memcpy((void *)(addr), (void *)(accmd_data_file_allocate_resp_ptr), 5)
#define ACCMD_DATA_FILE_ALLOCATE_RESP_UNMARSHALL(addr, accmd_data_file_allocate_resp_ptr) memcpy((void *)(accmd_data_file_allocate_resp_ptr), (void *)(addr), 5)
...
#define ACCMD_CLOCK_POWER_SAVE_MODE_RESP_MARSHALL(addr, accmd_clock_power_save_mode_resp_ptr) memcpy((void *)(addr), (void *)(accmd_clock_power_save_mode_resp_ptr), 5)
#define ACCMD_CLOCK_POWER_SAVE_MODE_RESP_UNMARSHALL(addr, accmd_clock_power_save_mode_resp_ptr) memcpy((void *)(accmd_clock_power_save_mode_resp_ptr), (void *)(addr), 5)
...
#define ACCMD_CALL_FUNCTION_RESP_MARSHALL(addr, accmd_call_function_resp_ptr) memcpy((void *)(addr), (void *)(accmd_call_function_resp_ptr), 5)
#define ACCMD_CALL_FUNCTION_RESP_UNMARSHALL(addr, accmd_call_function_resp_ptr) memcpy((void *)(accmd_call_function_resp_ptr), (void *)(addr), 5)
