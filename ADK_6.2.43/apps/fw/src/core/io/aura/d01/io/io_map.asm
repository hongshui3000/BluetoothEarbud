...
.CONST $SUB_SYS_DEBUGGER_REF_ID                 0xFFFF9100; //  R  16 bits
.CONST $_SUB_SYS_DEBUGGER_REF_ID                $SUB_SYS_DEBUGGER_REF_ID; //  R  16 bits
