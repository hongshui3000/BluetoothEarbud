/*!
    ...
    \version Part of 6.2
    \file chain_sco_wb.c
    \brief The chain_sco_wb chain. This file is generated by C:/qtil/ADK_QCC512x_QCC302x_WIN_6.2.43/tools/chaingen/chaingen.py.
*/
...
{
    MAKE_OPERATOR_CONFIG(CAP_ID_WBS_DEC, OPR_SCO_RECEIVE),
    MAKE_OPERATOR_CONFIG_PRIORITY_HIGH(CAP_ID_WBS_ENC, OPR_SCO_SEND),
    MAKE_OPERATOR_CONFIG(CAP_ID_CVC_RECEIVE_WB, OPR_CVC_RECEIVE),
    MAKE_OPERATOR_CONFIG_PRIORITY_LOW(CAP_ID_CVCHS1MIC_SEND_WB, OPR_CVC_SEND),
