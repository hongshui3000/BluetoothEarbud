...
/*! @brief Image upgrade maximum data block size.
    Maximum size of the data block that can be written to the QSPI device
    in each SinkFlush().
*/
#define IMAGE_UPGRADE_MAX_DATA_BLOCK_SIZE_BYTES  48
